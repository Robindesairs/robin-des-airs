...
window.I18N = (function() {
  ...
  var T = {
    fr: {
      ...
      section_comp_fineprint: "Certains concurrents affichent aussi 25% — mais lisez les petites lignes. Si votre dossier va au tribunal, leur commission grimpe à 35%, 44%, voire 50%. Chez Robin, 25% c'est 25%. Du début à la fin. Quoi qu'il arrive.",
      ...
      faq_9_a: "C'est nous qui vous payons. Une fois les fonds reçus de la compagnie, on vous demande votre RIB et on vous vire votre part sous 5 jours ouvrés. On ne vous demande jamais d'argent — ni carte bancaire, ni avance.",
      ...
      faq_12_a: "Oui. Droit de rétractation de 14 jours à compter de la signature du mandat. Annulation sans frais, sans justification.",
    ...
    en: {
      ...
      section_comp_fineprint: "Some competitors also show 25% — but read the small print. If your case goes to court, their commission jumps to 35%, 44%, or even 50%. At Robin, 25% is 25%. From start to finish. No matter what.",
      ...
      faq_1_a: "<p style=\"margin-bottom:14px;\"><strong>Robin takes 25% only when we win.</strong> You receive 75% net.</p><p style=\"margin-bottom:14px;font-size:13px;color:var(--gray);line-height:1.8;\">Short haul (&lt; 1,500 km) → €250 → you get <strong>€188</strong>. Medium (1,500–3,500 km) → €400 → you get <strong>€300</strong>. Long haul (&gt; 3,500 km) → €600 → you get <strong>€450</strong>.</p><p style=\"margin-bottom:10px;font-size:13px;\">Family of 4 on Paris–Dakar? 4 × €600 = €2,400 gross → <strong>€1,800 net</strong> for you. This commission never changes, even if your case goes to court.</p>",
      ...
      faq_7_a: "Competitors charge 30% to 50% of the compensation — and it goes up if the case goes to court. On €600, that's up to €300 taken. Robin takes 25%, even in court. We don't charge the client for complexity. On a Paris–Dakar for a family of 4, you keep €1,800 net. With others, you keep €1,200 to €1,560.",
      ...
      faq_9_a: "We pay you. Once we receive the funds from the airline, we ask for your bank details and transfer your share within 5 working days. We never ask you for money — no card, no advance.",
      ...
      faq_12_a: "Yes. 14-day right of withdrawal from signing the mandate. Cancellation with no fee, no reason required.",
