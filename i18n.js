...
window.I18N = (function() {
  ...
  var T = {
    fr: {
      ...
      hero_desc: "<strong>0 € si on perd. 25 % seulement si vous gagnez.</strong> Jamais d’avance, jamais de carte bancaire — c’est nous qui vous payons.",
    ...
    en: {
      ...
      hero_desc: "<strong>€0 if we lose. 25% only if you win.</strong> No upfront cost, no card details ever — we pay you.",
