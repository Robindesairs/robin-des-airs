...
window.I18N = (function() {
  ...
  var T = {
    fr: {
      ...
      hero_wa_demo_sr: "Exemple de conversation WhatsApp : Aminata envoie son numéro de vol puis une photo de sa carte d'embarquement ; Robin lit le vol et indique que ce retard peut donner droit à une indemnité, jusqu'à 600 € par passager (selon la distance et la cause), avec une vérification gratuite et sans engagement. Robin précise sa commission de 25 % au succès seulement (0 € sans résultat, aucune avance, pas de carte bancaire), que chaque passager d'une même famille compte (une famille de 4 peut obtenir jusqu'à 2 400 €), son expertise des vols Europe-Afrique (Dakar, Abidjan, Bamako) et qu'un conseiller peut rappeler en wolof, bambara ou lingala. Dernière étape : signer le contrat de cession.",
      ...
      hero_subhead: "<span class='hero-slogan'>Robin prend aux compagnies, rend aux familles.</span> <span class='hero-subhead-extra'>Vos lignes Europe ⇄ Afrique. Retard, annulation ou surbooking : on va chercher l'argent qu'elles vous doivent.</span>",
