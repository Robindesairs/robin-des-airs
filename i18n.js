...
window.I18N = (function() {
  ...
  var T = {
    fr: {
      ...
      why_us_line: "🌍 <strong>Spécialiste Afrique&nbsp;↔&nbsp;Europe</strong> · ☎️ un vrai conseiller vous rappelle dans votre langue, pas une plateforme injoignable. <a href='/blog/pourquoi-choisir-robin-des-airs-difference.html' style='color:var(--neon-dark);font-weight:700;text-decoration:none;white-space:nowrap'>Pourquoi nous choisir →</a>",
      nav_drawer_faq: "❓ FAQ",
    ...
    en: {
      ...
      why_us_line: "🌍 <strong>Africa&nbsp;↔&nbsp;Europe specialist</strong> · ☎️ a real advisor calls you back in your language, not an unreachable platform. <a href='/blog/pourquoi-choisir-robin-des-airs-difference.html' style='color:var(--neon-dark);font-weight:700;text-decoration:none;white-space:nowrap'>Why choose us →</a>",
      nav_drawer_faq: "❓ FAQ",
      nav_drawer_dest: "✈️ Guides & destinations (blog)",
      nav_drawer_blog: "📝 Blog",
