...
window.I18N = (function() {
  ...
  var T = {
    fr: {
      ...
      tarifs_meta_description: "Vous gardez plus : 25 % à l'amiable, 45 % seulement au tribunal (frais de procédure inclus). 450 € nets sur 600 €. Comparatif transparent Robin.",
      ...
      section_comp_desc: "Avant de signer, vous savez exactement combien vous recevez : 25 % en phase amiable, 45 % seulement si le dossier va jusqu'au tribunal — frais d'avocat et de procédure inclus, avancés par nous et à notre charge si nous perdons.",
      ...
      comp_r2_robin: "25% amiable / 45% tribunal",
      ...
      trust_2_d: "25% en phase amiable, 45% seulement au tribunal (frais d'avocat inclus). Annoncé avant de signer, jamais de frais cachés.",
    ...
    en: {
      ...
      tarifs_meta_description: "You keep more: 25% in the amicable phase, 45% only in court (procedure costs included). On €600 you receive €450 net. Transparent comparison.",
      ...
      section_comp_desc: "Before you sign, you know exactly how much you receive: 25% in the amicable phase, 45% only if the case goes to court — lawyer and procedure costs included, advanced by us and borne by us if we lose.",
      section_comp_fineprint: "Key point: same fee whether the airline resists or the case goes to court, details in the FAQ.",
      section_comp_fineprint_main: "In the amicable phase our share is 25\u00A0%. If the case goes to court it rises to 45\u00A0%: this covers all lawyer, bailiff and procedure costs in full, which we advance and bear ourselves if we lose. That is still below most competitors (35\u00A0% to 50\u00A0% in litigation), with €0 upfront and nothing to pay if we recover nothing.",
      ...
      comp_r2_robin: "25% amicable / 45% court",
      ...
      trust_2_d: "25% in the amicable phase, 45% only in court (legal fees included). Stated before you sign, never hidden fees.",
      ...
      founder_p4: "Robin des Airs is the opposite. We handle your case in French, Wolof, Bambara, Lingala, Twi, Yoruba and other languages. <strong style=\"color:white;\">Because we understand each other better when we speak the same language.</strong> We build a technical case the airline can't ignore. We take 25% in the amicable phase, 45% only if it goes to court (legal fees included) — stated upfront, never a hidden euro. No maximum volume. No hidden fees. A happy family and a recommendation to their loved ones, that's our model.",
