...
window.I18N = (function() {
  ...
  var T = {
    fr: {
      ...
      trust_2_t: "Commission dite d'avance",
      trust_2_d: "25% en phase amiable, 40% seulement au tribunal (frais d'avocat inclus). Annoncé avant de signer, jamais de frais cachés.",
    ...
    en: {
      ...
      trust_2_t: "Fee stated upfront",
      trust_2_d: "25% in the amicable phase, 40% only in court (legal fees included). Stated before you sign, never hidden fees.",
      ...
      faq_5_a: "Yes. An initial refusal is never final, it's often the start of negotiation. Many passengers stop at that first no, and that is exactly what the airline hopes: in the end, 62% of eligible passengers never receive what they are owed (European Commission, 2020). We take over the case, add our technical evidence, and resubmit with an argument the airline can't ignore. If they persist, we go to the ombudsman then to court. Fees are included in our commission: you pay nothing extra.",
