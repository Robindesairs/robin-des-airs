...
window.I18N = (function() {
  ...
  var T = {
    fr: {
      ...
      meta_description: "Vol retardé ou annulé ? Jusqu'à 600€ par passager (CE 261). On ne prend notre part (25%) qu'une fois votre argent récupéré — sinon vous ne payez rien. En général réponse le jour même (24h max).",
      ...
      hero_moins_cher: "Notre part (25%) une fois l'argent récupéré · Si on ne gagne pas, vous ne payez rien · En général le jour même (24h max)",
      ...
      hero_stat_24h: "Souvent le jour même",
      ...
      calc_disclaimer: "Notre part (25%) une fois l'argent récupéré · Si on ne gagne pas, vous ne payez rien · En général le jour même (24h max)",
      ...
      sp_24h: "En général <strong>le jour même</strong> · 24h max",
      ...
      funnel_wa_shortcut_text: "Sur WhatsApp : numéro de vol + date — on vérifie votre éligibilité. En général le jour même (24h max).",
      ...
      short_done_hint: "Ouvrez WhatsApp : on reprend votre vol et votre numéro — complétez la date si besoin. En général réponse le jour même (24h max).",
    ...
    en: {
      ...
      meta_description: "Delayed or cancelled flight? Up to €600 per passenger (EU 261). We only take our share (25%) once your money is recovered — otherwise you pay nothing. Usually same day (24h max).",
      ...
      hero_moins_cher: "Our share (25%) once money is recovered · If we don't win, you pay nothing · Usually same day (24h max)",
      ...
      funnel_step_short: "2 questions",
      calc_disclaimer: "Our share (25%) once money is recovered · If we don't win, you pay nothing · Usually same day (24h max)",
      ...
      sp_24h: "Usually <strong>same day</strong> · 24h max",
      ...
      funnel_wa_shortcut_text: "On WhatsApp: flight number + date — we check your eligibility. Usually same day (24h max).",
      ...
      short_done_hint: "Open WhatsApp: we include your flight and number — add the date if needed. Usually a reply the same day (24h max).",
