...
window.I18N = (function() {
  ...
  var T = {
    fr: {
      ...
      hero_wa_demo_sr: "Exemple de conversation WhatsApp : Aminata envoie son numéro de vol puis une photo de sa carte d'embarquement ; Robin lit le vol et indique que ce retard peut donner droit à une indemnité, jusqu'à 600 € par passager (selon la distance et la cause), avec une vérification gratuite et sans engagement. Robin précise sa commission de 25 % au succès seulement (0 € si on ne gagne pas, aucune avance, pas de carte bancaire), que chaque passager d'une même famille compte (une famille de 4 peut obtenir jusqu'à 2 400 €), son expertise des vols Europe-Afrique (Dakar, Abidjan, Bamako) et qu'un conseiller peut rappeler en wolof, bambara ou lingala. Dernière étape : signer le mandat.",
      ...
      promise_p2: "<strong style=\"color:rgba(255,255,255,0.9);\">Zéro risque :</strong> aucune avance, aucun frais de dossier. <strong>Si on ne gagne pas, vous ne payez rien.</strong>",
      ...
      result_free_note: "Gratuit si on ne gagne pas · Réponse WhatsApp sous 24h",
      ...
      footer_mandate: "Mandat de représentation (signer en ligne)",
      footer_mandat_pdf: "Mandat PDF (FR)",
      ...
      hero_promises: "<li>🚫 Jamais d'avance</li><li>💳 Sans carte bancaire</li><li>💶 On vous paie</li>",
      ...
      calc_disclaimer: "25 % au succès · 0 € si on perd · Dossier monté sous 24h",
      ...
      how_step2_desc: "Un mandat rapide sur votre téléphone. Zéro paperasse, zéro déplacement. Après ça, vous n'avez plus rien à faire.",
    ...
    en: {
      ...
      promise_p2: "<strong style=\"color:rgba(255,255,255,0.9);\">Zero risk:</strong> no upfront cost, no case fees. <strong>If we don't win, you pay nothing.</strong>",
      promise_p3: "<strong style=\"color:rgba(255,255,255,0.9);\">WhatsApp support:</strong> Direct, human follow-up, no phone queues.",
      result_free_note: "Free if we don't win · WhatsApp reply within 24h",
      ...
      footer_mandate: "Letter of authority (sign online)",
      footer_mandat_pdf: "Mandate PDF (FR)",
      ...
      funnel_step_short: "2 questions",
      calc_disclaimer: "25% on success · €0 if we lose · Case filed within 24h",
      ...
      how_step2_desc: "A quick mandate on your phone. Zero paperwork, zero travel. After that, you don't have to do anything.",
