...
window.I18N = (function() {
  ...
  var T = {
    fr: {
      ...
      hero_lang_line: "Service disponible en : Français, Wolof, Bambara, Soninké, Peul (Pulaar), Dioula, Swahili, Lingala…",
      ...
      comp_r7_l: "Langues africaines (wolof, bambara, lingala, peul/pulaar, dioula, swahili…)",
    ...
    en: {
      ...
      hero_lang_line: "Service available in: French, English, Wolof, Bambara, Soninké, Peul (Pulaar), Dioula, Swahili, Lingala…",
      ...
      comp_r7_l: "African languages (Wolof, Bambara, Lingala, Peul/Pulaar, Dioula, Swahili…)",
