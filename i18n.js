...
window.I18N = (function() {
  ...
  var T = {
    fr: {
      ...
      vol_ticker_sr: "Bandeau dynamique : vols du moment (retards ou annulations). Jusqu'à 600 € si le règlement CE 261 s'applique. Cliquez sur une pastille pour préremplir le formulaire.",
    ...
    en: {
      ...
      vol_ticker_sr: "Live strip: current flights (delays or cancellations). Up to €600 if EU Regulation 261 applies. Click a pill to pre-fill the form.",
