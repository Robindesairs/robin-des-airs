...
window.I18N = (function() {
  ...
  var T = {
    fr: {
      wa_online: "● en ligne",
      wa_demo_tag: "Exemple",
      hero_wa_demo_foot: "On parle votre langue · réponse en quelques minutes →",
      hero_wa_demo_sr: "Exemple de conversation WhatsApp : Aminata envoie son numéro de vol puis une photo de sa carte d'embarquement ; Robin lit le vol et indique que ce retard peut donner droit à une indemnité, jusqu'à 600 € par passager (selon la distance et la cause). Robin récupère l'argent à la place du passager et va jusqu'au tribunal à ses frais si la compagnie refuse de payer, sans que le passager n'avance quoi que ce soit. Vérification gratuite et sans engagement, rémunération au succès uniquement : 25 % en phase amiable (0 € sans résultat, aucune avance, pas de carte bancaire), 40 % seulement si le dossier va jusqu'au tribunal, frais d'avocat et de procédure inclus et avancés par Robin. Chaque passager d'une même famille compte (une famille de 4 peut obtenir jusqu'à 2 400 € au total). Expertise des vols Europe-Afrique (Dakar, Abidjan, Bamako) et un conseiller peut rappeler en wolof, bambara ou lingala. Dernière étape : signer le contrat de cession.",
      step1_hint: "Pas de souci si vous ne vous souvenez plus des détails, on vérifie pour vous.",
      step1c_nesaispas_msg: "Pas de souci, on vérifiera les registres météo pour vous.",
      step1b_eyebrow: "Étape 1b, Délai de prévenance",
      step1b_q: "Quand avez-vous appris l'annulation ?",
      step1b_late_main: "Moins de 14 jours avant le départ",
      step1b_late_sub: "Annulation tardive → indemnisation pleine ✅",
      step1b_early_main: "Plus de 14 jours avant le départ",
      step1b_early_sub: "Préavis suffisant, indemnisation probablement non due",
      step2_eyebrow: "Étape 2 sur 5, Type de trajet",
      step2_hint: "En quelques minutes, vous savez ce que vous touchez.",
      step2_q: "Ce voyage était-il direct ou avec correspondance ?",
      step2_direct_main: "Vol direct",
      step2_direct_sub: "Sans escale",
      step2_direct_note: "Sans escale, calcul simplifié",
      step2_escale_main: "Avec correspondance",
      step2_escale_sub: "1 escale ou plus",
      step2_escale_note: "C'est le dernier vol qui compte, on explique",
      step3a_eyebrow: "Étape 3 sur 5, Détails du vol",
      step3a_hint: "Indiquez votre numéro de vol, ou les villes de départ et d'arrivée.",
      calc_no_flight: "Je ne trouve pas mon vol",
      calc_main_flights_title: "Principaux vols Air France / Corsair / Air Sénégal (Afrique subsaharienne)",
      calc_city_search_label: "Ville de départ et d'arrivée (recherche : ville ou code IATA)",
      calc_guide_help: "Besoin d'aide ? <a href=\"/blog/vol-retarde-dakar-paris-indemnite.html\" target=\"_blank\" rel=\"noopener\">Lire notre guide sur le vol Paris-Dakar</a>",
      calc_flight_date: "Date du vol",
      step3b_eyebrow: "Étape 3 sur 5, Vos deux vols",
      step3b_hint: "Robin des Airs : c'est le dernier vol qui détermine l'indemnité.",
      step3b_info: "La loi CE 261 prend la <strong>distance totale</strong> départ (1er vol) → arrivée finale (dernier vol). Le <strong>dernier vol</strong> détermine l'indemnité.",
      calc_vol1_label: "Vol 1, Premier tronçon",
      calc_flight_number_opt: "Numéro de vol <span style=\"color:rgba(255,255,255,0.35);font-size:9px;\">optionnel</span>",
      calc_vol2_label: "Vol 2, Dernier tronçon <span style=\"color:var(--neon-b);font-size:9px;\">CE VOL COMPTE</span>",
      calc_vol3_label: "Vol 3",
      calc_add_vol3: "+ Ajouter un 3e vol",
      calc_departure_date: "Date de départ",
      funnel_almost: "Plus qu'une étape. Votre résultat arrive.",
      loader_steps: "Vérification Eurocontrol · Analyse distance · CE 261/2004",
      res_raison_label: "Raison invoquée par la compagnie :",
      promise_p1: "<strong style=\"color:rgba(255,255,255,0.9);\">25 % seulement, au succès.</strong> Les autres services prennent souvent 35 % à 50 %.",
      promise_p2: "<strong style=\"color:rgba(255,255,255,0.9);\">Zéro risque :</strong> aucune avance, aucun frais de dossier. <strong>Si vous n'êtes pas indemnisé, vous ne payez rien.</strong>",
      promise_p3: "<strong style=\"color:rgba(255,255,255,0.9);\">Accompagnement WhatsApp :</strong> Un suivi humain et direct sans attente téléphonique.",
      result_free_note: "Gratuit sans résultat · Réponse WhatsApp sous 24h",
      nope_title: "⚠️ Ce vol ne semble pas éligible à l'indemnisation",
      exit_capture_title: "📩 Vous avez un prochain vol prévu ?",
      exit_capture_body: "Laissez votre email, on vous alerte automatiquement si un retard ouvre un droit.",
      exit_capture_btn: "M'alerter gratuitement",
      exit_referral_title: "👥 Vous connaissez quelqu'un dont le vol a été retardé ?",
      exit_referral_body: "Partagez Robin, chaque passager peut toucher jusqu'à 600€.",
      testi_disclaimer: "<strong style=\"color:#92400E\">ℹ️ Ces exemples sont pédagogiques.</strong> Ils illustrent les indemnités prévues par le règlement européen <a href=\"https://eur-lex.europa.eu/legal-content/FR/TXT/?uri=CELEX%3A32004R0261\" target=\"_blank\" rel=\"noopener external\" style=\"color:#B45309;text-decoration:underline\">CE 261/2004</a>. Ils ne constituent pas des avis clients. Robin des Airs est en phase de pré-lancement&nbsp;: les premiers avis vérifiés seront publiés après ouverture officielle du service.",
      testi_name_1: "Cas type, retard long-courrier",
      testi_name_2: "Cas type, annulation tardive",
      testi_name_4: "Cas type, refus de l'avoir",
      testi_name_6: "Cas type, surbooking",
      ...
      footer_slogan: "\"On prend aux compagnies,<br>on rend à nos familles.\"",
      footer_trust: "SASU Robin des Airs, immatriculation en cours<br>0 € d'avance",
      footer_guide_heading: "Guide du Voyageur",
      footer_blog: "Blog, guides et articles",
      footer_jurisprudence: "Jurisprudence CJUE (CE 261)",
      footer_ce261_summary: "Résumé du règlement CE 261",
      footer_resources_heading: "Ressources",
      footer_meteo: "Météo et dossier (TAF, METAR…)",
      footer_why_few: "Pourquoi si peu récupèrent leur indemnité ?",
      footer_ai_docs: "Documentation IA (llms.txt)",
      footer_ai_index: "Index complet des URLs",
      footer_crm: "Espace équipe",
      footer_cgv: "CGV",
      footer_privacy: "Politique de confidentialité",
      footer_mandate: "Contrat de cession de créance (signer en ligne)",
      footer_mandat_pdf: "Contrat de cession PDF (FR)",
      footer_withdrawal: "Droit de rétractation",
      ...
      calc_flight_number: "Numéro de vol",
      calc_city_from: "Ville de départ",
      calc_city_to: "Ville de fin",
      calc_passengers: "Passagers",
      share_whatsapp_btn: "💬 Partager sur WhatsApp",
      page_title: "Robin des Airs, Indemnités aériennes jusqu'à 600€ | Premium",
      meta_description: "Retard, annulation ou surbooking ? Jusqu'à 600 € par passager (CE 261). 25 % seulement après encaissement, sinon 0 €. Dossier sous 24 h.",
      tarifs_page_title: "Nos tarifs, Robin des Airs",
      tarifs_meta_description: "Vous gardez plus : 25 % à l'amiable, 40 % seulement au tribunal (frais de procédure inclus). 450 € nets sur 600 €. Comparatif transparent Robin.",
      ...
      diaspora_bar_flags_aria: "Diaspora : Cameroun, Comores, Côte d'Ivoire, Madagascar, Mali, Nigeria, RDC, Sénégal, et toute l'Afrique.",
      diaspora_flags_more: "+ toute l'Afrique",
      ...
      vol_ticker_label: "On parle votre langue : wolof, bambara, peul, dioula… et bien d'autres",
      vol_ticker_label_short: "On parle votre langue",
      ...
      hero_wa_note: "Sur WhatsApp en français · on vous rappelle en wolof, bambara ou lingala si vous préférez 📞",
      hero_title: "Vol Europe-Afrique\nretardé ou annulé ?\n",
      hero_title_neon: "Récupérez jusqu'à 600 €",
      hero_subhead: "<span class='hero-slogan'>Robin prend aux compagnies, rend aux familles.</span> <span class='hero-subhead-extra'>Vos lignes Europe ⇄ Afrique. Retard, annulation ou surbooking : on récupère l'argent qu'elles vous doivent à votre place, jusqu'au tribunal s'il le faut, sans que vous avanciez rien.</span>",
      hero_diaspora_why: "On connaît vos lignes, on parle votre langue, on récupère les 600€ pour nos communautés et nos familles.",
      hero_desc: "<strong>Pas de succès, pas de frais.</strong> C'est nous qui vous payons, viré directement sur votre compte.",
      hero_promises: "<li>🚫 Jamais d'avance</li><li>💶 On vous paie</li><li>💸 Payé même sans compte en Europe</li>",
      trust_lead: "🚀 <strong>Service en lancement</strong>. Soyez parmi les premières familles de la diaspora à récupérer ce que les compagnies vous doivent.",
      trust_grid: "<li class='trust-cell'><span class='trust-ico' aria-hidden='true'>⚖️</span><span class='trust-txt'><strong>Droit européen CE 261/2004</strong>Le règlement que les compagnies doivent respecter, celui qu'appliquent les leaders du secteur.</span></li><li class='trust-cell'><span class='trust-ico' aria-hidden='true'>🛡️</span><span class='trust-txt'><strong>0 € sans résultat</strong>Jamais d'avance, jamais de carte bancaire. C'est nous qui vous payons.</span></li><li class='trust-cell'><span class='trust-ico' aria-hidden='true'>🔒</span><span class='trust-txt'><strong>Vos données protégées</strong>RGPD, jamais revendues, supprimées sur simple demande.</span></li><li class='trust-cell'><span class='trust-ico' aria-hidden='true'>🗣️</span><span class='trust-txt'><strong>On parle votre langue</strong>Wolof, mandinka, twi, yoruba, peul… et 14 jours pour vous rétracter, sans frais.</span></li>",
      hero_btn_calc: "Estimer en ligne, sans WhatsApp ni Meta (2 min) →",
      hero_btn_wa: "💰 Récupérer mon argent sur WhatsApp",
      hero_entry_hint: "📲 Tout sur WhatsApp, rien à remplir · on vous rappelle dans votre langue",
      hero_entry_alt: "Pas de WhatsApp ? <a href=\"/depot-express.html\" onclick=\"plausible('Depot-Dossier', {props:{source:'hero-alt'}})\" style=\"color:var(--neon-dark);font-weight:600;\">Déposez votre dossier en ligne →</a>",
      hero_entry_badge: "📲 Dossier complet sur WhatsApp, rien à remplir",
      hero_step_1: "<strong>1.</strong> Vous envoyez vol + date",
      hero_step_2: "<strong>2.</strong> On vérifie l'éligibilité",
      hero_step_3: "<strong>3.</strong> Contrat de cession en ligne, on récupère pour vous",
      hero_stat_fee: "Notre part de succès",
      hero_stat_note: "On n'accepte que les dossiers solides, zéro frais si on ne récupère rien.",
      ...
      wa_rgpd_hint: "WhatsApp est un service <strong>Meta</strong> : des données peuvent être traitées hors UE. <a href=\"/politique-confidentialite.html#whatsapp-meta\">Confidentialité &amp; alternatives</a> (email, site).",
      wa_rgpd_hint_short: "Service Meta, <a href=\"/politique-confidentialite.html#whatsapp-meta\">données &amp; alternatives</a>",
      hero_moins_cher: "Notre part (25%) une fois l'argent récupéré · Si vous n'êtes pas indemnisé, vous ne payez rien · Montage dossier sous 24h",
      ...
      hero_stat_net_max: "Max par passager",
      hero_stat_won: "Dossiers gagnés",
      hero_stat_lost: "Sans résultat",
      hero_stat_24h: "Dossier sous 24h",
      nav_cta: "Combien on me doit ? →",
      ...
      nav_drawer_testi: "💼 Exemples de cas",
      nav_drawer_why: "⭐ Pourquoi nous",
      why_us_line: "🌍 <strong>Spécialiste Afrique&nbsp;↔&nbsp;Europe</strong> · 👤 un <strong>expert dédié</strong> suit votre dossier et vous rappelle dans votre langue. <a href='/blog/pourquoi-choisir-robin-des-airs-difference.html' style='color:var(--neon-dark);font-weight:700;text-decoration:none;white-space:nowrap'>Pourquoi nous choisir →</a>",
      nav_drawer_faq: "❓ FAQ",
      nav_drawer_dest: "✈️ Guides & destinations (blog)",
      nav_drawer_blog: "📝 Blog",
      nav_drawer_depot: "📤 Déposer mon dossier",
      calc_tag: "Indemnité vol · Robin des Airs",
      ...
      funnel_card_sub: "On vous dit en 2 min si votre vol vaut une indemnité. Gratuit.",
      funnel_wa_main_btn: "💬 Savoir combien on me doit (jusqu'à 600 €)",
      funnel_or: "ou décrivez votre vol ici :",
      funnel_short_submit: "Envoyer et savoir si j'ai droit à une indemnité →",
      funnel_step_short: "2 questions",
      calc_disclaimer: "25 % au succès · 0 € sans résultat · Dossier monté sous 24h",
      ...
      step1_correspondance_note: "Le retard de votre 1er vol vous a empêché de prendre la suite, c'est en général indemnisable, on vérifie votre cas.",
      ...
      section_how_title: "Comment ça se passe,\nconcrètement.",
      ...
      loi_you_depart_eu_p: "Vol au départ de l'<strong>UE</strong> : <strong>toute compagnie doit payer</strong>, européenne ou non, quelle que soit votre nationalité. Jusqu'à 600 € en cas de retard, annulation ou surbooking.",
      loi_delay_arrival_note: "<strong>Retard de 3 h ou plus à l'arrivée</strong> = indemnité. C'est l'heure d'arrivée qui compte, pas le décollage.",
      ...
      loi_80percent: "<strong style=\"color:var(--navy);\">en cas d'annulation, moins de 20 % des passagers éligibles obtiennent leur indemnité.</strong> Pas parce qu'ils n'y ont pas droit, parce que les compagnies comptent sur leur abandon. Et vous avez <strong style=\"color:var(--navy);\">5 ans</strong> pour réclamer : votre vol de 2021 qui avait du retard ? L'argent est toujours là.",
      ...
      loi_tiers_note: "Vols plus courts : 250 € ou 400 €. On calcule votre montant exact.",
      ...
      dest_desc: "Vol retardé ou annulé sur une ligne Europe → Afrique ou Afrique → Europe vers l'une de ces villes ? Vous êtes potentiellement éligible au palier maximum (600 €) selon la distance et les conditions.",
      ...
      sp_24h: "Montage dossier sous <strong>24h</strong>",
      sp_families: "Nos familles nous font confiance, des centaines de dossiers réglés",
      sp_cta: "C'est mon tour →",
      how_step1_title: "Vous envoyez votre vol",
      how_step1_desc: "Envoyez votre numéro de vol sur WhatsApp, comme un message à un ami. On vous dit tout de suite si vous pouvez être indemnisé, et combien.",
      how_step2_title: "Vous signez, on fonce",
      how_step2_desc: "Un contrat de cession rapide sur votre téléphone. Zéro paperasse, zéro déplacement. Après ça, vous n'avez plus rien à faire.",
      how_step3_title: "On se bat avec la compagnie",
      how_step3_desc: "Réclamation, preuves, relances : c'est notre métier. Si elle résiste, on va jusqu'au bout, tribunal compris — à nos frais, pas les vôtres.",
      how_step4_title: "Vous recevez votre argent",
      how_step4_desc: "La compagnie paie, on vous vire votre part. Si on ne récupère rien, vous ne payez rien. Zéro risque.",
      how_step1_time: "⏱ 2 minutes",
      how_step2_time: "⏱ 3 minutes",
      how_step3_time: "⏱ On gère",
      ...
      footer_tagline: "Réclamation aérienne · Spécialiste Diaspora · Prix fixe · Gratuit sans résultat",
      ...
      footer_newsletter_desc:
        "Conseils CE 261, réforme européenne et actualités diaspora, 1 e-mail utile de temps en temps.",
      footer_newsletter_email_label: "Votre e-mail",
      footer_newsletter_placeholder: "votre@email.com",
      footer_newsletter_submit: "S'inscrire",
      footer_newsletter_consent:
        "J'accepte de recevoir la newsletter Robin des Airs. <a href=\"/politique-confidentialite.html\">Politique de confidentialité</a> désinscription à tout moment.",
      footer_newsletter_ok: "Merci ! Vous recevrez nos prochains conseils par e-mail.",
      footer_newsletter_already: "Vous êtes déjà inscrit(e). Merci !",
      footer_newsletter_sending: "Inscription en cours…",
      footer_newsletter_err_email: "Indiquez votre adresse e-mail.",
      footer_newsletter_err_consent: "Cochez la case pour recevoir la newsletter.",
      footer_newsletter_err: "Inscription impossible. Réessayez ou écrivez-nous.",
      ...
      section_comp_title: "Vous gardez plus. On s'engage là-dessus.",
      section_comp_desc: "Avant de signer, vous savez exactement combien vous recevez : 25 % en phase amiable, 40 % seulement si le dossier va jusqu'au tribunal — frais d'avocat et de procédure inclus, avancés par nous et à notre charge si nous perdons.",
      section_comp_fineprint: "La différence clé : votre part reste de 75 % si la compagnie résiste, et n'est de 60 % que si le dossier va jusqu'au tribunal, frais de procédure inclus. Détail dans la FAQ.",
      section_comp_fineprint_main: "En phase amiable, notre part est de 25\u00A0%. Si le dossier va jusqu'au tribunal, elle passe à 40\u00A0% : cette majoration couvre l'intégralité des frais d'avocat, d'huissier et de procédure, que nous avançons et gardons à notre charge si nous perdons. Cela reste souvent inférieur aux concurrents (35\u00A0% à 50\u00A0% au contentieux), avec 0\u00A0€ d'avance et rien à payer si nous ne récupérons rien.",
      ...
      section_comp_sources: "Grilles tarifaires publiques des principaux services, mars 2026.",
      comp_h_crit: "Critère",
      comp_h_robin: "✈ Robin",
      comp_h_others: "Les autres",
      comp_r1_l: "Notre part",
      comp_r2_l: "Si la compagnie résiste ou procès",
      comp_r2_robin: "25% amiable / 40% tribunal",
      comp_r3_l: "Sur <strong>600\u00A0€</strong> vous recevez",
      comp_r_famille_l: "Famille de 4, vous recevez",
      comp_r_suivi_l: "Suivi",
      comp_r_suivi_robin: "WhatsApp direct",
      ...
      testi_quote_9: "<strong>Tarification Robin des Airs.</strong> Vous percevez 75 % du montant encaissé. 0 € si aucune récupération. Aucun frais d'avance, aucun coût caché.",
      ...
      trust_2_t: "Part annoncée d'avance",
      trust_2_d: "Vous percevez 75 % en phase amiable, 60 % seulement au tribunal (frais d'avocat inclus). Annoncé avant de signer, jamais de frais cachés.",
      trust_3_t: "Zéro frais sans résultat",
      ...
      funnel_detail_link: "Estimer en ligne, sans WhatsApp (5 étapes) →",
      res_tag: "✈ Estimation pour votre dossier",
      res_net_label: "net pour vous · dans votre poche",
      loi_net_pocket: "par passager · long-courrier",
      loi_legal_600: "Vous gardez 450 € nets · notre part 25 % au succès",
      ...
      short_wa_visible_phone_note: "Rien à saisir ici : depuis WhatsApp, on voit votre numéro.",
      ...
      short_done_hint: "Ouvrez WhatsApp : on reprend votre vol et votre numéro, complétez la date si besoin.",
      short_done_wa_btn: "📱 Vérifier sur WhatsApp",
      btn_suivant: "Suivant →",
      btn_envoyer: "Envoyer →",
      btn_retour: "← Retour",
      faq_1_q: "✈️ Vol retardé, annulé ou surbooké : j'ai droit à combien ?",
      faq_1_a: "<p style=\"margin-bottom:14px;\">Au départ d'Europe, un vol <strong>retardé de plus de 3 heures à l'arrivée</strong>, annulé ou surbooké ouvre droit à <strong>600 € par passager</strong> au-delà de 3 500 km, quelle que soit la compagnie.</p><p style=\"margin-bottom:14px;font-size:13px;line-height:1.8;\">L'indemnité est due <strong>par personne</strong> : une famille de 4 sur un Paris-Dakar, c'est <strong>2 400 €</strong>. Le dossier s'ouvre <strong>en 2 minutes sur WhatsApp</strong> avec votre numéro de vol. Vous n'avancez jamais rien.</p><p style=\"margin-bottom:10px;font-size:13px;\">Sur les sommes récupérées, <strong>vous percevez 75 %</strong> en règlement amiable, et 60 % si le dossier va jusqu'au tribunal (frais d'avocat et de procédure inclus, avancés par nous). Si rien n'est récupéré, vous ne devez rien.</p><p style=\"margin-bottom:0;font-size:12px;color:var(--gray);line-height:1.7;\">Vols de 1 500 à 3 500 km, Maghreb et Outre-mer compris : <strong>400 € par passager</strong>.</p>",
      faq_2_q: "⏱️ Combien de temps faut-il pour recevoir mon indemnité ?",
      faq_2_a: "<p>Ça dépend de la réactivité de la compagnie. Voici les trois scénarios possibles :</p><p><strong>La compagnie coopère (60% des cas)</strong> après réception de notre dossier technique (preuves du retard, bulletins météo officiels, analyse de la jurisprudence), la compagnie reconnaît votre droit et paie. Délai : 4 à 12 semaines. C'est le cas le plus fréquent, les compagnies savent que nos dossiers sont solides et préfèrent payer plutôt que d'aller plus loin.</p><p><strong>La compagnie résiste (30% des cas)</strong> elle invoque des \"circonstances extraordinaires\" pour refuser. On contre ses arguments avec nos preuves météo et les données de trafic aérien du jour. On saisit le Médiateur du Tourisme et du Voyage en votre nom. Le médiateur rend sa recommandation sous 90 jours. Dans la grande majorité des cas, la compagnie suit et paie. Délai total : 3 à 5 mois.</p><p><strong>La compagnie persiste (moins de 10% des cas)</strong> même après le médiateur, elle refuse. On saisit le tribunal à nos frais et à nos risques. Délai total : 5 à 8 mois.</p><p>Vous percevez 75 % en phase amiable et en médiation ; si nous devons saisir le tribunal, votre part est de 60 % (frais d'avocat et de procédure avancés par nous). Et si on ne récupère rien, vous ne payez rien. On vous tient informé à chaque étape par WhatsApp.</p>",
      ...
      faq_5_a: "Oui. Un refus initial n'est jamais définitif, c'est souvent le début de la négociation. Beaucoup de passagers s'arrêtent pourtant à ce premier non, et c'est exactement ce que la compagnie espère : au bout du compte, 62 % des passagers éligibles ne perçoivent jamais ce qui leur est dû (Commission européenne, 2020). On reprend le dossier, on l'enrichit avec nos preuves techniques, et on relance avec un argumentaire que la compagnie ne peut pas ignorer. Si elle persiste, on passe au médiateur puis au tribunal. Les frais sont déjà couverts par notre part : vous ne payez rien de plus.",
      ...
      faq_7_a: "Oui. C'est le dernier vol (tronçon final) qui détermine le montant : distance totale et retard à l'arrivée finale. Si vous avez raté une correspondance à cause d'un retard du premier vol, c'est en général indemnisable, on vérifie votre cas. Indiquez \"avec correspondance\" dans le diagnostic, on s'occupe du reste.",
      faq_8_q: "✅ Vous prenez tous les dossiers ?",
      faq_8_a: "Non, et c'est ce qui fait notre force. On analyse chaque dossier gratuitement avant de l'accepter. Si vos chances sont faibles, on vous le dit honnêtement plutôt que de vous faire perdre du temps. On ne s'engage que quand on est confiants de gagner. Et si on ne prend pas votre dossier, on vous explique pourquoi et on vous conseille sur les alternatives.",
      faq_9_q: "↩️ Est-ce que je peux me rétracter ?",
      faq_9_a: "Oui. Vous disposez d'un droit de rétractation de 14 jours à compter de la signature du contrat de cession, sans justification et sans frais. Concrètement : nous commençons à travailler sur votre dossier dès la signature, avec votre accord, pour ne pas perdre de temps. Si vous vous rétractez pendant les 14 jours, vous ne payez rien, le travail déjà effectué est à notre charge. Si votre dossier aboutit avant la fin des 14 jours (c'est rare mais possible), et que vous n'avez pas exercé votre rétractation, la répartition convenue s'applique normalement. C'est un droit légal (art. L221-18 du Code de la consommation). Un simple message WhatsApp ou email à expert@robindesairs.eu suffit.",
      faq_10_q: "🔒 Le site est-il sécurisé ? Mes documents sont-ils protégés ?",
      faq_10_a: "Oui. Votre connexion est <strong>entièrement chiffrée</strong> (HTTPS) et notée <strong>A+</strong>, la note maximale, par SSL Labs — le test indépendant de référence pour le chiffrement. Nous ne vous demandons <strong>aucune coordonnée bancaire</strong> pour lancer votre dossier : vous ne payez rien à l'avance. Vos documents servent <strong>uniquement</strong> à constituer votre dossier d'indemnisation, et l'accès à nos dossiers est protégé par une <strong>double authentification</strong>. Conformément au RGPD, vous pouvez à tout moment demander l'accès à vos données ou leur suppression (expert@robindesairs.eu).",
      founder_story_short: "20 ans dans l'aviation, toujours les mêmes excuses. Robin monte un dossier solide et vous suit en français, wolof, bambara. On gagne ou vous ne payez rien.",
      ...
      founder_p4: "Robin des Airs, c'est l'inverse. On gère votre dossier en français, wolof, bambara, lingala, twi, yoruba et autres langues. <strong style=\"color:white;\">Parce qu'on se comprend mieux quand on parle la même langue.</strong> On monte un dossier technique que la compagnie ne peut pas ignorer. Et on prend 25% en phase amiable, 40% seulement si ça va au tribunal (frais d'avocat inclus) — annoncé avant de signer, jamais un euro caché. Pas de volume maximum. Pas de frais cachés. Une famille contente et une recommandation à ses proches, c'est ça notre modèle.",
      founder_years: "Années dans le secteur",
      founder_won: "Dossiers remportés",
      founder_lost: "Sans résultat",
      founder_stats_line: "20 années dans le secteur · Dossiers sélectionnés avec soin · Sinon vous ne payez rien",
      ...
      founder_note: "Notre part (25%) une fois l'argent récupéré · Si vous n'êtes pas indemnisé, vous ne payez rien · Réponse en moins de 2h · Droit de rétractation 14 jours",
      wa_float_text: "Combien on me doit ? (gratuit)",
      wa_float_aria: "Combien la compagnie vous doit ? Vérifier gratuitement sur WhatsApp, Robin des Airs"
    },
    en: {
      wa_online: "● online",
      wa_demo_tag: "Example",
      hero_wa_demo_foot: "We speak your language · reply in minutes →",
      hero_wa_demo_sr: "Example WhatsApp conversation: Ama sends her flight number then a photo of her boarding pass; Robin reads the flight and explains this delay may entitle her to compensation, up to €600 per passenger (depending on distance and cause), with a free no-commitment check. Robin charges 25% on success only (€0 if no result, no upfront fee, no card needed), notes that every passenger in a family counts (a family of 4 can get up to €2,400), specialises in Europe-Africa flights (Accra, Lagos, Abidjan) and that an adviser can call back in Twi, Yoruba or Pidgin. Last step: sign the claim-assignment contract.",
      step1_hint: "No worries if you don't remember the details, we'll check for you.",
      step1c_nesaispas_msg: "No worries, we'll check the weather records for you.",
      step1b_eyebrow: "Step 1b, Notice period",
      step1b_q: "When did you learn of the cancellation?",
      step1b_late_main: "Less than 14 days before departure",
      step1b_late_sub: "Late cancellation → full compensation ✅",
      step1b_early_main: "More than 14 days before departure",
      step1b_early_sub: "Enough notice, compensation likely not due",
      step2_eyebrow: "Step 2 of 5, Trip type",
      step2_hint: "In minutes, you'll know what you're owed.",
      step2_q: "Was this trip direct or with a connection?",
      step2_direct_main: "Direct flight",
      step2_direct_sub: "Non-stop",
      step2_direct_note: "Non-stop, simplified calculation",
      step2_escale_main: "With a connection",
      step2_escale_sub: "1 stop or more",
      step2_escale_note: "The last flight is what counts, we explain",
      step3a_eyebrow: "Step 3 of 5, Flight details",
      step3a_hint: "Enter your flight number, or the departure and arrival cities.",
      calc_no_flight: "I can't find my flight",
      calc_main_flights_title: "Main Air France / Corsair / Air Sénégal flights (sub-Saharan Africa)",
      calc_city_search_label: "Departure and arrival city (search: city or IATA code)",
      calc_guide_help: "Need help? <a href=\"/blog/vol-retarde-dakar-paris-indemnite.html\" target=\"_blank\" rel=\"noopener\">Read our Paris-Dakar flight guide</a>",
      calc_flight_date: "Flight date",
      step3b_eyebrow: "Step 3 of 5, Your two flights",
      step3b_hint: "Robin des Airs: it's the last flight that determines the compensation.",
      step3b_info: "EU 261 uses the <strong>total distance</strong> from departure (1st flight) → final arrival (last flight). The <strong>last flight</strong> determines the compensation.",
      calc_vol1_label: "Flight 1, First leg",
      calc_flight_number_opt: "Flight number <span style=\"color:rgba(255,255,255,0.35);font-size:9px;\">optional</span>",
      calc_vol2_label: "Flight 2, Last leg <span style=\"color:var(--neon-b);font-size:9px;\">THIS FLIGHT COUNTS</span>",
      calc_vol3_label: "Flight 3",
      calc_add_vol3: "+ Add a 3rd flight",
      calc_departure_date: "Departure date",
      funnel_almost: "One more step. Your result is coming.",
      loader_steps: "Eurocontrol check · Distance analysis · EU 261/2004",
      res_raison_label: "Reason given by the airline:",
      promise_p1: "<strong style=\"color:rgba(255,255,255,0.9);\">25% only, on success.</strong> Other services often take 35% to 50%.",
      promise_p2: "<strong style=\"color:rgba(255,255,255,0.9);\">Zero risk:</strong> no upfront cost, no case fees. <strong>If we recover nothing, you pay nothing.</strong>",
      promise_p3: "<strong style=\"color:rgba(255,255,255,0.9);\">WhatsApp support:</strong> Direct, human follow-up, no phone queues.",
      result_free_note: "Free if no result · WhatsApp reply within 24h",
      nope_title: "⚠️ This flight doesn't appear eligible for compensation",
      exit_capture_title: "📩 Have an upcoming flight?",
      exit_capture_body: "Leave your email, we'll alert you automatically if a delay creates a right to claim.",
      exit_capture_btn: "Alert me for free",
      exit_referral_title: "👥 Know someone whose flight was delayed?",
      exit_referral_body: "Share Robin, each passenger can get up to €600.",
      testi_disclaimer: "<strong style=\"color:#92400E\">ℹ️ These examples are illustrative.</strong> They show the compensation set out by European regulation <a href=\"https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32004R0261\" target=\"_blank\" rel=\"noopener external\" style=\"color:#B45309;text-decoration:underline\">EC 261/2004</a>. They are not customer reviews. Robin des Airs is in pre-launch&nbsp;: the first verified reviews will be published after the service officially opens.",
      testi_name_1: "Typical case, long-haul delay",
      testi_name_2: "Typical case, late cancellation",
      testi_name_4: "Typical case, voucher refused",
      testi_name_6: "Typical case, overbooking",
      ...
      footer_slogan: "\"We take from the airlines,<br>we give back to our families.\"",
      footer_trust: "Robin des Airs (SASU), registration in progress<br>No upfront fee",
      footer_guide_heading: "Traveler's Guide",
      footer_blog: "Blog, guides & articles",
      footer_jurisprudence: "CJEU case law (EU 261)",
      footer_ce261_summary: "EU 261 regulation summary",
      footer_resources_heading: "Resources",
      footer_meteo: "Weather & case file (TAF, METAR…)",
      footer_why_few: "Why so few claim their compensation?",
      footer_ai_docs: "AI documentation (llms.txt)",
      footer_ai_index: "Full URL index",
      footer_crm: "Team area",
      footer_cgv: "Terms (T&Cs)",
      footer_privacy: "Privacy policy",
      footer_mandate: "Claim-assignment contract (sign online)",
      footer_mandat_pdf: "Claim-assignment contract PDF (FR)",
      footer_withdrawal: "Right of withdrawal",
      ...
      calc_flight_number: "Flight number",
      calc_city_from: "Departure city",
      calc_city_to: "Arrival city",
      calc_passengers: "Passengers",
      share_whatsapp_btn: "💬 Share on WhatsApp",
      page_title: "Robin des Airs, Flight compensation up to €600 | Premium",
      meta_description: "Delay, cancellation or denied boarding? Up to €600 per passenger (EU261). 25% only after payout, otherwise you pay €0. Case file within 24h.",
      tarifs_page_title: "Our rates, Robin des Airs",
      tarifs_meta_description: "You keep more: 25% in the amicable phase, 40% only in court (procedure costs included). On €600 you receive €450 net. Transparent comparison.",
      ...
      hero_wa_note: "On WhatsApp in English · we call you back in Twi, Yoruba or Pidgin if you prefer 📞",
      hero_title: "Flight Europe-Africa\ndelayed or cancelled?\n",
      hero_title_neon: "Get up to €600 back",
      hero_subhead: "<span class='hero-slogan'>Robin takes from airlines, gives back to families.</span> <span class='hero-subhead-extra'>Your Europe ⇄ Africa routes, delay, cancellation or overbooking: we go get the money they owe you.</span>",
      hero_diaspora_why: "We know your routes, we speak your language, we recover the €600 for our communities and our families.",
      hero_desc: "<strong>No win, no fee.</strong> We're the ones who pay you, straight to your account.",
      hero_promises: "<li>🚫 No upfront cost</li><li>💶 We pay you</li><li>💸 Paid even without a EU bank account</li>",
      trust_lead: "🚀 <strong>Now launching</strong> be among the first diaspora families to claim back what airlines owe you.",
      trust_grid: "<li class='trust-cell'><span class='trust-ico' aria-hidden='true'>⚖️</span><span class='trust-txt'><strong>European law EC 261/2004</strong>The regulation airlines must respect, the same one the market leaders use.</span></li><li class='trust-cell'><span class='trust-ico' aria-hidden='true'>🛡️</span><span class='trust-txt'><strong>€0 if no result</strong>No upfront cost, no card details, we're the ones who pay you.</span></li><li class='trust-cell'><span class='trust-ico' aria-hidden='true'>🔒</span><span class='trust-txt'><strong>Your data protected</strong>GDPR, never resold, deleted on request.</span></li><li class='trust-cell'><span class='trust-ico' aria-hidden='true'>🗣️</span><span class='trust-txt'><strong>We speak your language</strong>Wolof, Mandinka, Twi, Yoruba, Peul… and 14 days to withdraw, free of charge.</span></li>",
      hero_btn_calc: "Estimate online, no WhatsApp, no Meta (2 min) →",
      hero_btn_wa: "💰 Get my money back on WhatsApp",
      hero_entry_hint: "📲 All on WhatsApp, nothing to fill in · we call you back in your language",
      hero_entry_alt: "No WhatsApp? <a href=\"/depot-express.html\" onclick=\"plausible('Depot-Dossier', {props:{source:'hero-alt'}})\" style=\"color:var(--neon-dark);font-weight:600;\">Submit your case online →</a>",
      hero_entry_badge: "📲 Whole claim on WhatsApp, nothing to fill in",
      ...
      hero_stat_fee: "Our success fee",
      hero_stat_note: "We only take strong cases, zero fees if we recover nothing.",
      ...
      wa_rgpd_hint: "WhatsApp is a <strong>Meta</strong> service: data may be processed outside the EU. <a href=\"/politique-confidentialite.html#whatsapp-meta\">Privacy &amp; alternatives</a> (email, website).",
      wa_rgpd_hint_short: "Meta service, <a href=\"/politique-confidentialite.html#whatsapp-meta\">data &amp; alternatives</a>",
      hero_moins_cher: "Our share (25%) once money is recovered · If we recover nothing, you pay nothing · Case file within 24h",
      ...
      hero_stat_net_max: "Max per passenger",
      hero_stat_won: "Cases won",
      hero_stat_lost: "Without result",
      hero_stat_24h: "File within 24h",
      nav_cta: "What am I owed? →",
      nav_english_version: "🇬🇧 English",
      ...
      nav_drawer_testi: "💼 Case examples",
      nav_drawer_why: "⭐ Why us",
      why_us_line: "🌍 <strong>Africa&nbsp;↔&nbsp;Europe specialist</strong> · 👤 a <strong>dedicated expert</strong> handles your case and calls you back in your language. <a href='/blog/pourquoi-choisir-robin-des-airs-difference.html' style='color:var(--neon-dark);font-weight:700;text-decoration:none;white-space:nowrap'>Why choose us →</a>",
      nav_drawer_faq: "❓ FAQ",
      nav_drawer_dest: "✈️ Guides & destinations (blog)",
      nav_drawer_blog: "📝 Blog",
      nav_drawer_depot: "📤 Submit my case",
      calc_tag: "Flight compensation · Robin des Airs",
      calc_title: "Check in 2 min\nif you're eligible",
      calc_title_1: "Check in 2 min",
      funnel_subtitle: "if you're eligible",
      funnel_card_title: "Your flight",
      funnel_card_sub: "We tell you in 2 min if your flight is owed compensation. Free.",
      funnel_wa_main_btn: "💬 See what I'm owed (up to €600)",
      funnel_or: "or describe your flight here:",
      funnel_short_submit: "Send and find out if I'm owed compensation →",
      funnel_step_short: "2 questions",
      calc_disclaimer: "25% on success · €0 if no result · Case filed within 24h",
      ...
      loi_you_depart_eu_p: "Flight departing the <strong>EU</strong>: <strong>any airline must pay</strong>, European or not, whatever your nationality. Up to €600 for delay, cancellation or overbooking.",
      loi_delay_arrival_note: "<strong>3+ hours late at arrival</strong> = compensation. It's the arrival time that counts, not departure.",
      ...
      loi_80percent: "<strong style=\"color:var(--navy);\">when a flight is cancelled, fewer than 20% of eligible passengers actually receive their compensation.</strong> Not because they're not entitled, because airlines count on them giving up. And you have <strong style=\"color:var(--navy);\">5 years</strong> to claim: that 2021 flight that was delayed? The money is still there.",
      loi_closing: "Not sure? <a href=\"https://wa.me/33756863630\" target=\"_blank\" rel=\"noopener\" style=\"color:var(--neon-dark);text-decoration:underline;font-weight:800;\">Send us your flight on WhatsApp</a> free check within the day. <strong style=\"color:var(--navy);\">when a flight is cancelled, fewer than 20% of eligible passengers actually receive their compensation</strong> airlines count on people giving up. You have <strong style=\"color:var(--navy);\">5 years</strong> to claim, that delayed flight in 2021? The money may still be owed.",
      ...
      loi_tiers_note: "Shorter flights: €250 or €400. We calculate your exact amount.",
      ...
      sp_24h: "Case file within <strong>24h</strong>",
      sp_families: "Our families trust us, hundreds of cases settled",
      sp_cta: "My turn →",
      how_step1_title: "You send your flight",
      how_step1_desc: "Send your flight number on WhatsApp, like a message to a friend. We tell you straight away if you're eligible, and how much.",
      how_step2_title: "You sign, we go",
      how_step2_desc: "A quick claim-assignment contract on your phone. Zero paperwork, zero travel. After that, you don't have to do anything.",
      how_step3_title: "We fight the airline",
      how_step3_desc: "Claim, evidence, follow-ups: that's our job. If they resist, ombudsman then court — at our expense, not yours.",
      how_step4_title: "You get your money",
      how_step4_desc: "The airline pays, we transfer your share. If we recover nothing, you pay nothing. Zero risk.",
      how_step1_time: "⏱ 2 minutes",
      how_step2_time: "⏱ 3 minutes",
      how_step3_time: "⏱ We handle it",
      ...
      footer_tagline: "Air claim · Diaspora specialist · Fixed price · No result, no fee",
      footer_nav: "Navigation",
      footer_landmark_title: "Site links and information",
      footer_legal: "Legal",
      footer_contact: "Contact",
      ...
      footer_newsletter_heading: "Newsletter",
      footer_newsletter_desc:
        "EU 261 tips, regulatory updates and diaspora news, occasional useful emails only.",
      footer_newsletter_email_label: "Your email",
      footer_newsletter_placeholder: "you@email.com",
      footer_newsletter_submit: "Subscribe",
      footer_newsletter_consent:
        "I agree to receive the Robin des Airs newsletter. <a href=\"/politique-confidentialite.html\">Privacy policy</a> unsubscribe anytime.",
      footer_newsletter_ok: "Thank you! You'll receive our next updates by email.",
      footer_newsletter_already: "You're already subscribed. Thank you!",
      footer_newsletter_sending: "Subscribing…",
      footer_newsletter_err_email: "Please enter your email address.",
      footer_newsletter_err_consent: "Please tick the box to subscribe.",
      footer_newsletter_err: "Subscription failed. Try again or contact us.",
      ...
      section_comp_title: "You keep more. We're committed to that.",
      section_comp_desc: "Before you sign, you know exactly how much you receive: 25% in the amicable phase, 40% only if the case goes to court — lawyer and procedure costs included, advanced by us and borne by us if we lose.",
      section_comp_fineprint: "Key point: your share stays at 75% if the airline resists, and is 60% only if the case goes to court, procedure costs included. Details in the FAQ.",
      section_comp_fineprint_main: "In the amicable phase our share is 25\u00A0%. If the case goes to court it rises to 40\u00A0%: this covers all lawyer, bailiff and procedure costs in full, which we advance and bear ourselves if we lose. That is still below most competitors (35\u00A0% to 50\u00A0% in litigation), with €0 upfront and nothing to pay if we recover nothing.",
      ...
      section_comp_sources: "Public rate cards from major services, March 2026.",
      comp_h_crit: "Criteria",
      comp_h_robin: "✈ Robin",
      comp_h_others: "Others",
      comp_r1_l: "Our share",
      comp_r2_l: "If the airline resists or it goes to court",
      comp_r2_robin: "25% amicable / 40% court",
      comp_r3_l: "On <strong>€600</strong> you receive",
      comp_r_famille_l: "Family of 4, you receive",
      comp_r_suivi_l: "Updates",
      comp_r_suivi_robin: "Direct on WhatsApp",
      ...
      comp_r9_l: "If we recover nothing",
      ...
      testi_quote_9: "<strong>Robin des Airs pricing.</strong> You receive 75% of the amount recovered. €0 if no recovery. No upfront fees, no hidden costs.",
      ...
      trust_2_t: "Share stated upfront",
      trust_2_d: "You receive 75% in the amicable phase, 60% only in court (legal fees included). Stated before you sign, never hidden fees.",
      trust_3_t: "No fee with no result",
      ...
      funnel_detail_link: "Estimate online, no WhatsApp (5 steps) →",
      res_tag: "✈ Estimate for your case",
      res_net_label: "net for you · in your pocket",
      loi_net_pocket: "per passenger · long-haul",
      loi_legal_600: "You keep €450 net · our 25% fee on success only",
      ...
      short_wa_visible_phone_note: "Nothing to type here, we see your number when you message us on WhatsApp.",
      ...
      short_done_hint: "Open WhatsApp: we include your flight and number, add the date if needed.",
      short_done_wa_btn: "📱 Check on WhatsApp",
      btn_suivant: "Next →",
      btn_envoyer: "Send →",
      btn_retour: "← Back",
      faq_1_q: "✈️ Flight delayed, cancelled or overbooked: how much am I owed?",
      faq_1_a: "<p style=\"margin-bottom:14px;\">Departing from Europe, a flight <strong>delayed more than 3 hours on arrival</strong>, cancelled or overbooked entitles you to <strong>€600 per passenger</strong> beyond 3,500 km, whichever airline operated it.</p><p style=\"margin-bottom:14px;font-size:13px;line-height:1.8;\">Compensation is owed <strong>per person</strong>: a family of 4 on a Paris-Dakar flight is <strong>€2,400</strong>. Your case opens <strong>in 2 minutes on WhatsApp</strong> with your flight number. You never pay anything upfront.</p><p style=\"margin-bottom:10px;font-size:13px;\">Of the sums recovered, <strong>you receive 75%</strong> in the amicable phase, and 60% if the case goes to court (lawyer and procedure costs included, advanced by us). If nothing is recovered, you owe nothing.</p><p style=\"margin-bottom:0;font-size:12px;color:var(--gray);line-height:1.7;\">Flights of 1,500 to 3,500 km, Maghreb and French overseas departments included: <strong>€400 per passenger</strong>.</p>",
      faq_2_q: "⏱️ How long until I receive my compensation?",
      faq_2_a: "<p>It depends on how responsive the airline is. Three possible scenarios:</p><p><strong>The airline cooperates (60% of cases)</strong> after receiving our technical file (proof of delay, official weather reports, legal analysis), the airline recognises your right and pays. Timeline: 4 to 12 weeks. This is the most common outcome.</p><p><strong>The airline resists (30% of cases)</strong> it invokes \"extraordinary circumstances\". We counter with our weather evidence and air traffic data. We refer your case to the Tourism and Travel Ombudsman. Recommendation within 90 days. In most cases the airline follows and pays. Total: 3 to 5 months.</p><p><strong>The airline persists (under 10%)</strong> we take the case to court at our expense and risk. Total: 5 to 8 months.</p><p>You receive 75% in the amicable phase and mediation; if we must go to court your share is 60% (procedure costs advanced by us). If we recover nothing, you pay nothing. We keep you updated via WhatsApp.</p>",
      ...
      faq_5_a: "Yes. An initial refusal is never final, it's often the start of negotiation. Many passengers stop at that first no, and that is exactly what the airline hopes: in the end, 62% of eligible passengers never receive what they are owed (European Commission, 2020). We take over the case, add our technical evidence, and resubmit with an argument the airline can't ignore. If they persist, we go to the ombudsman then to court. Fees are already covered by our share: you pay nothing extra.",
      faq_6_q: "💳 How do I get paid?",
      faq_6_a: "We pay you. We will never ask for your bank details on WhatsApp. Once your case is accepted, and when funds are received from the airline, we request your bank details via email or a secure form and transfer your share within 5 business days. We never ask you for money, no card, no advance.",
      ...
      faq_8_a: "No, and that's our strength. We review every case for free before accepting it. If your chances are low, we tell you honestly rather than waste your time. We only take on cases we're confident we can win. If we don't take your case, we explain why and advise you on alternatives.",
      faq_9_q: "↩️ Can I withdraw?",
      faq_9_a: "Yes. You have a 14-day right of withdrawal from signing the claim-assignment contract, no reason and no fee. In practice, we start working on your case right after signature (with your agreement) so we don't lose time. If you withdraw within 14 days, you pay nothing, any work already done is on us. If your case succeeds before the 14 days end (rare but possible) and you haven't withdrawn, the agreed split applies normally. This is a legal right (French Consumer Code, art. L221-18). A simple WhatsApp message or an email to expert@robindesairs.eu is enough.",
      faq_10_q: "🔒 Is the website secure? Is my data protected?",
      faq_10_a: "Yes. Your connection is <strong>fully encrypted</strong> (HTTPS) and rated <strong>A+</strong>, the top grade, by SSL Labs — the independent industry benchmark for encryption. We <strong>never ask for bank-card details</strong> to start your case: you pay nothing upfront. Your documents are used <strong>solely</strong> to build your compensation claim, and access to our files is protected by <strong>two-factor authentication</strong>. Under the GDPR, you can request access to your data or its deletion at any time (expert@robindesairs.eu).",
      founder_story_short: "20 years in aviation, always the same excuses. Robin builds a solid case and supports you in French, Wolof, Bambara. We win or you pay nothing.",
      ...
      founder_p4: "Robin des Airs is the opposite. We handle your case in French, Wolof, Bambara, Lingala, Twi, Yoruba and other languages. <strong style=\"color:white;\">Because we understand each other better when we speak the same language.</strong> We build a technical case the airline can't ignore. We take 25% in the amicable phase, 40% only if it goes to court (legal fees included) — stated upfront, never a hidden euro. No maximum volume. No hidden fees. A happy family and a recommendation to their loved ones, that's our model.",
      founder_years: "Years in the sector",
      founder_won: "Cases won",
      founder_lost: "Without result",
      founder_stats_line: "20 years in the sector · Carefully selected cases · Otherwise you pay nothing",
      ...
      founder_note: "Our share (25%) once money is recovered · If we recover nothing, you pay nothing · Reply within 2h · 14-day right of withdrawal",
      wa_float_text: "What am I owed? (free)",
      wa_float_aria: "What the airline owes you? Check for free on WhatsApp, Robin des Airs"
    }
  };
