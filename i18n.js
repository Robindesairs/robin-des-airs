...
window.I18N = (function() {
  ...
  var T = {
    fr: {
      ...
      hero_desc: "<strong>0 € si on perd. 25 % seulement si vous gagnez.</strong> Pas d’avance, jamais.",
    ...
    en: {
      ...
      hero_desc: "<strong>€0 if we lose. 25% only if you win.</strong> No upfront cost, ever.",
