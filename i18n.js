...
window.I18N = (function() {
  ...
  var T = {
    fr: {
      ...
      founder_story_short: "Vingt ans dans le secteur aérien. J'ai vu les mêmes excuses revenir à chaque vol retardé : \"météo imprévisible\", \"circonstances extraordinaires\". J'ai vu des familles entières repartir sans rien après 6 heures d'attente — pour un baptême, des funérailles, des retrouvailles.<br><br>Robin des Airs, c'est l'inverse. Un dossier technique que la compagnie ne peut pas ignorer. Suivi en français, wolof, bambara et d'autres langues : plus facile de s'expliquer dans sa langue maternelle. On ne prend notre part (25%) qu'une fois votre argent récupéré. Vous le savez avant même de signer.",
