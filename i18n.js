...
window.I18N = (function() {
  ...
  var T = {
    fr: {
      ...
      vol_ticker_empty: "Aucun vol Europe ↔ Afrique ≥ 3 h (annulation ou retard à l’arrivée) détecté aujourd’hui — bandeau mis à jour en temps réel.",
      vol_ticker_empty_sr: "Aucun des derniers vols impactés Europe–Afrique (retard à l’arrivée d’au moins 3 h ou annulation) n’a été détecté aujourd’hui sur les hubs suivis.",
      ...
      footer_vol_ticker_data_note: "Bandeau : jusqu’à 10 derniers vols impactés (annulation ou retard à l’arrivée ≥ 3 h) sur lignes Europe ↔ Afrique, mis à jour via AeroDataBox (hubs France + principales villes africaines). Si aucun vol ne correspond aujourd’hui, un message l’indique — pas d’exemples fictifs. Jusqu’à 600 € si le CE 261 s’applique. Un clic sur une pastille préremplit le formulaire.",
    ...
    en: {
      ...
      vol_ticker_empty: "No Europe ↔ Africa flight with 3h+ arrival delay or cancellation detected today — live data.",
      vol_ticker_empty_sr: "No impacted Europe–Africa flights (3h+ arrival delay or cancellation) detected today on monitored hubs.",
