...
window.I18N = (function() {
  ...
  var T = {
    ...
    en: {
      ...
      hero_wa_demo_sr: "Example of a WhatsApp conversation: you send your flight number then a photo of your boarding pass; Robin reads the flight, confirms eligibility and the amount — up to €600 per passenger. Robin notes the 25% success fee only (€0 if we don't win, no upfront cost), expertise on Europe–Africa flights (Dakar, Abidjan, Bamako) and that he replies in Wolof, Bambara, Lingala or French.",
