...
window.I18N = (function() {
  ...
  var T = {
    fr: {
      ...
      faq_5_a: "Oui. Un refus initial n'est jamais définitif, c'est souvent le début de la négociation. une réclamation valide sur deux est rejetée dès la première demande (APRA, 2024), et beaucoup de passagers s'arrêtent là. C'est exactement ce que la compagnie espère. On reprend le dossier, on l'enrichit avec nos preuves techniques, et on relance avec un argumentaire que la compagnie ne peut pas ignorer. Si elle persiste, on passe au médiateur puis au tribunal. Les frais sont inclus dans notre commission : vous ne payez rien de plus.",
    ...
    en: {
      ...
      faq_5_a: "Yes. An initial refusal is never final, it's often the start of negotiation. one valid claim in two is rejected at the first request (APRA, 2024), and many passengers stop there. That is exactly what the airline hopes. We take over the case, add our technical evidence, and resubmit with an argument the airline can't ignore. If they persist, we go to the ombudsman then to court. Fees are included in our commission: you pay nothing extra.",
