/**
 * Indicatifs téléphoniques (E.164) — noms en français, drapeaux Unicode.
 * Une ligne par code pays principal (doublons +1, +44, etc. regroupés).
 */
window.CRM_DIAL_LINES = [
  '1|🇺🇸|États-Unis / Canada',
  '7|🇷🇺|Russie / Kazakhstan',
  '20|🇪🇬|Égypte',
  '27|🇿🇦|Afrique du Sud',
  ...
  '244|🇦🇴|Angola',
  '245|🇬🇼|Guinée-Bissau',
  '246|🇮🇴|Territoire britannique océan Indien',
  '248|🇸🇨|Seychelles',
  '249|🇸🇩|Soudan',
  '250|🇷🇼|Rwanda',
  '251|🇪🇹|Éthiopie',
