  ...
  function init() {
    ...
    var STEPS_BY_LANG = {
      fr: function () { return [
        ...
        { who: 'robin',  typing: 800,  hold: 2400, html: 'Robin prend aux compagnies, rend aux familles 🏹' },
      ...
      en: function () { return [
        ...
        { who: 'robin',  typing: 800,  hold: 2400, html: 'Robin takes from the airlines, gives back to families 🏹' },
