...
(function (global) {
  ...
  const STR = {
    fr: {
      ...
      'guide.desc':
        '3 actions : déposer un dossier, suivre vos réclamations, voir vos commissions (3 800 GMD par passager gagné).',
      ...
      'kpi.comm.sub': '3 800 GMD par passager gagné',
      ...
      'pricing.note':
        'Commission agence : 3 800 GMD par passager indemnisé (≈ 45 € à 84 GMD/€). Paiement sous 48h (Wave, Afrimoney, QMoney).',
      ...
      'comm.sub': '3 800 GMD par passager gagné — Wave / Afrimoney / QMoney sous 48 h',
      ...
      'help.body':
        'Les dossiers sont enregistrés directement dans Airtable. L\'équipe Robin les traite comme un dépôt bureau.',
    ...
    en: {
      ...
      'guide.desc':
        '3 actions: submit a case, track claims, view commissions (3,800 GMD per winning passenger).',
      ...
      'kpi.comm.sub': '3,800 GMD per winning passenger',
      ...
      'pricing.note':
        'Agency commission: 3,800 GMD per compensated passenger (≈ €45 at 84 GMD/€). Paid within 48h (Wave, Afrimoney, QMoney).',
      ...
      'col.pax': 'Passengers',
      'comm.title': 'Commissions',
      'comm.sub': '3,800 GMD per winning passenger — Wave / Afrimoney / QMoney within 48h',
      ...
      'help.body':
        'All cases are stored directly in Airtable. The Robin team processes them like a desk submission.',
