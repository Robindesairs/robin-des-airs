---
title: "Convention de Montréal : se faire rembourser un retard prouvé"
meta_title: "Convention de Montréal : rembourser frais réels d'un vol retardé (jusqu'à ~6 300 DTS)"
meta_description: "Vol non éligible au CE 261 ? La Convention de Montréal peut permettre de réclamer vos frais réels (hôtel, repas, rendez-vous manqué) sur justificatifs, jusqu'à ~6 300 DTS."
slug: convention-montreal-retard-frais-prouver-prejudice
...
- **CE 261** : forfait fixe, aucune preuve de dépense à fournir.
- **Convention de Montréal** : remboursement des **frais réellement engagés**, sur **justificatifs**, dans la limite d'un plafond.
...
- **Nuit(s) d'hôtel** imposée(s) par le retard
- **Repas** pris pendant l'attente
- **Transport de substitution** (taxi, train, correspondance rachetée)
- **Rendez-vous professionnel manqué** entraînant une perte financière chiffrable
- **Prestation non remboursable perdue** (nuit d'hôtel réservée à destination, excursion, location)
...
- **Vol soumis au CE 261** (départ d'un aéroport de l'UE, ou arrivée dans l'UE sur une compagnie de l'UE) : vous visez d'abord le **forfait** 250/400/600 €, plus vos frais d'assistance.
- **Vol hors champ du CE 261** (ex. compagnie non-UE, entre deux pays hors UE) : la **Convention de Montréal** peut prendre le relais pour vos frais réels, sur justificatifs.
...
Voir aussi : [Réglementation CE 261](/blog/reglementation-ce261-resume.html), [Montants 250/400/600 €](/blog/indemnite-vol-montants-250-400-600.html), [Compagnie qui refuse de payer](/blog/compagnie-refuse-payer-indemnite-que-faire.html).
