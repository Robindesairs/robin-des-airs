---
title: "Panne technique et CE261 : la compagnie doit payer (arrêt Wallentin-Hermann)"
...
faq:
  - q: "Ma compagnie dit que mon vol a été retardé pour 'raisons techniques'. Elle est exonérée ?"
    a: "Non, dans la grande majorité des cas. L'arrêt Wallentin-Hermann (CJUE, 2008) dit que les pannes techniques font partie de l'exploitation normale — la compagnie **doit payer l'indemnité**."
  - q: "Quelle panne technique peut exonérer une compagnie ?"
    a: "Seulement une panne causée par un événement imprévisible et externe : débris sur la piste endommageant l'appareil, collision avec un oiseau inattendue, ou défaut de fabrication récemment découvert par le constructeur. La panne mécanique ordinaire ne suffit pas."
  - q: "La compagnie a fourni un rapport technique. C'est suffisant pour refuser l'indemnité ?"
...
- Un numéro de rapport technique
...
Voir aussi : [Compagnie refuse de payer — que faire ?](/blog/compagnie-refuse-payer-indemnite-que-faire.html), [Arrêt Sturgeon — le seuil 3h](/blog/arret-sturgeon-3h-retard-jurisprudence.html), [Circonstances extraordinaires météo](/blog/vol-annule-meteo-circonstances-extraordinaires-recours.html).

→ [Contester le refus de ma compagnie](https://robindesairs.eu/#funnel-box)
