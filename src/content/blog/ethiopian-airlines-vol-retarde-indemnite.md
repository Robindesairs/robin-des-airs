...
faq:
  ...
  - q: "Ethiopian Airlines est-elle une compagnie européenne ?"
    a: "Non, Ethiopian Airlines est une compagnie éthiopienne, donc non européenne. Conséquence : elle n'est couverte par le forfait CE 261 que sur les vols **au départ d'un aéroport de l'UE**. Au départ d'Addis-Abeba, le forfait n'est pas dû, sauf si le vol est opéré par une compagnie européenne."
  - q: "Mon vol retour vers l'Afrique sur Ethiopian Airlines a été très retardé. Rien du tout ?"
  ...
  - q: "Mon billet Ethiopian Airlines avait une correspondance. Comment est calculé le retard ?"
    a: "Sur une **réservation unique**, le retard se mesure à la **destination finale** (arrêt Folkerts, CJUE). Ethiopian Airlines est le premier hub d'Afrique : Addis-Abeba dessert plus de 60 villes africaines en correspondance, donc les correspondances sont fréquentes : un retard de 3h+ à l'arrivée finale ouvre droit à l'indemnité, sur la distance totale."
  ...
  - q: "Combien de temps pour réclamer à Ethiopian Airlines ?"
...
- **Le vol part d'un aéroport de l'UE** : couvert quelle que soit la compagnie, Ethiopian Airlines incluse.
- **Le vol est opéré par une compagnie européenne** : couvert dans les deux sens.

| Trajet | Indemnité CE 261 si retard >= 3h |
|---|---|
| Paris (UE) vers Addis-Abeba, sur Ethiopian Airlines | Oui : **600 € par passager** (départ UE) |
| Addis-Abeba vers Paris, opéré par une compagnie européenne | Oui : **600 €** (opérateur UE) |
| Addis-Abeba vers Paris, opéré par Ethiopian Airlines | Non : frais réels via Convention de Montréal |

Le seuil se mesure **à l'arrivée** (ouverture des portes), pas au départ.

## Correspondances : le point important avec Ethiopian Airlines

Ethiopian Airlines est le premier hub d'Afrique : Addis-Abeba dessert plus de 60 villes africaines en correspondance. Beaucoup de passagers voyagent donc en correspondance. Sur un **billet unique**, l'indemnité se calcule sur la **destination finale** et la **distance totale** (arrêt Folkerts, CJUE 2013). Une correspondance manquée qui vous fait arriver avec 3h+ de retard est indemnisable, même si une étape est opérée par une autre compagnie. La créance est déterminée par le vol effectif (arrêt Wegener, CJUE).

## Vol annulé sur Ethiopian Airlines : vos droits

Si Ethiopian Airlines annule votre vol au départ de l'UE et vous prévient **moins de 14 jours** avant, vous avez droit à l'**indemnité de 600 €** par passager, **plus** le remboursement du billet OU un réacheminement, au choix. Ces droits se cumulent (art. 7 et art. 8). Un bon d'achat ne remplace le remboursement en argent que si vous l'acceptez : vous pouvez le refuser.
...
Quel que soit le sens de votre vol Ethiopian Airlines, la **Convention de Montréal** couvre vos bagages : jusqu'à **environ 1 800 €** (1 519 DTS) par passager en cas de perte ou de dommage. Réflexe indispensable : remplir un **PIR (Property Irregularity Report)** au comptoir avant de quitter l'aéroport. Sans PIR, la réclamation est quasi impossible.

## Famille : chaque passager compte

L'indemnité est due **par passager**, sans distinction d'âge. Famille de 4 sur un vol Ethiopian Airlines éligible retardé de 4h : 4 x 600 € = **2 400 € récupérés**, dont vous recevez **1 800 €** (75 %) en phase amiable.

## Comment réclamer avec Robin des Airs

Spécialiste des corridors Afrique-Europe, Robin des Airs vérifie l'éligibilité de votre vol (sens, opérateur réel, distance, cause), monte le dossier, envoie la réclamation à Ethiopian Airlines et conteste les refus. **0 € si rien n'est récupéré.** Robin des Airs vous **achète votre créance** : vous recevez **75 %** des sommes récupérées en phase amiable, et **60 %** si la compagnie nous oblige à saisir le tribunal, l'avocat et les frais de procédure restant à notre charge.
...
- **Dans votre langue, au téléphone.** Un doute, une question en amharique ? On vous rappelle et on vous explique de vive voix.
