...
faq:
  - q: "La médiation MTV est-elle obligatoire avant le tribunal ?"
    a: "Oui, depuis le 7 février 2026 (décret du 5 août 2025). Sans médiation préalable, votre recours en justice est irrecevable. Il faut d'abord une réclamation écrite à la compagnie, puis la saisine d'un médiateur de la consommation."
  ...
  - q: "Peut-on éviter les mois de médiation ?"
    a: "Oui. En **cédant votre créance** à un service CE 261, votre dossier devient un litige entre professionnels : la médiation consommateur ne s'applique plus (CJUE **C-551/24**), et le service peut aller **directement au contentieux**. Vous ne payez qu'en cas de succès, **0 € d'avance**."
  - q: "La médiation oblige-t-elle la compagnie à me payer ?"
...
Depuis le **7 février 2026**, la **médiation est obligatoire** avant tout recours au tribunal pour un litige aérien. L'organisme principal en France est le **Médiateur Tourisme et Voyage (MTV)**. Voici comment le saisir efficacement, et pourquoi une autre voie va souvent plus vite.

> ⏱️ **Avant de vous lancer dans plusieurs mois de médiation :** la saisine du MTV est **gratuite mais lente et incertaine** (environ 60 % de succès, dossier technique à monter vous-même). Il existe un raccourci. En **cédant votre créance** à Robin des Airs, votre dossier ne part plus en médiation consommateur : il devient un litige **entre professionnels**, on peut aller droit au but. Vérification **gratuite**, **0 € d'avance**, vous ne payez qu'en cas de succès, **jusqu'à 600 € par passager**.
>
...
## Quelles compagnies aériennes sont membres du MTV ?

Le MTV traite les litiges contre les compagnies **adhérentes** au dispositif. La plupart le sont :

- Air France, Corsair, Transavia, Air Caraïbes
- KLM, Brussels Airlines, TAP Portugal, Lufthansa
- Royal Air Maroc, Tunisair, Air Algérie (variable)
- Ryanair, Vueling (variable selon l'année)

Liste à jour sur **mtv.travel**.

## Et si ma compagnie n'est pas membre du MTV ?
...
## Comment saisir le MTV étape par étape
...
- Motif du litige (retard ≥ 3h, annulation, surbooking)
- Montant réclamé (250 / 400 / 600€ × passagers)
- Joindre les pièces

### 4. Attendre l'acceptation
Le MTV examine d'abord la **recevabilité** : compagnie adhérente, demande préalable faite, délai non prescrit. Réponse sous **3 semaines** environ.
...
Tant qu'il n'y a **aucun risque judiciaire réel**, une compagnie n'a aucune raison de payer vite. Ce qui la fait bouger, ce n'est pas une recommandation, c'est une **assignation**. Il faut donc aller vite et taper fort. C'est exactement ce que fait un service qui rachète votre créance : il assigne, à ses frais et à ses risques.

## Le raccourci : céder sa créance plutôt que médier soi-même

La médiation MTV est pensée pour un particulier face à une compagnie. C'est **gratuit**, mais c'est aussi **lent** (3 à 5 mois), **incertain** (environ 60 %) et c'est **à vous** de monter le dossier : réunir les preuves, calculer l'heure d'arrivée réelle, anticiper l'argument des « circonstances extraordinaires ».

Il existe une autre voie. Quand vous **cédez votre créance** à un service spécialisé CE 261, ce n'est plus vous (un consommateur) qui réclamez : c'est le service, un **professionnel**, qui agit en son nom contre la compagnie. Le litige devient **B2B**. Or la médiation consommateur obligatoire (article L.612-1 du Code de la consommation) ne concerne que les litiges consommateur ↔ professionnel : elle **ne s'applique plus**. C'est ce qu'a confirmé la CJUE dans l'arrêt **Lufthansa c/ AirHelp (C-551/24, 9 octobre 2025)**, qui renvoie les dossiers cédés devant le **tribunal de commerce**.

Résultat : le service peut **sauter l'étape de médiation** et aller directement au contentieux avec un dossier déjà solide. Plus rapide, plus de poids face à la compagnie, et **rien à monter de votre côté**.

<div style="display:flex;flex-wrap:wrap;gap:14px;margin:1.5rem 0">
<div style="flex:1 1 250px;border:1px solid #E2E6EE;border-radius:12px;overflow:hidden;background:#fff">
<div style="background:#6B7280;color:#fff;font-weight:800;padding:11px 14px;font-size:13px">😩 Seul : la voie classique</div>
<div style="padding:14px">
<div style="background:#F3F4F6;border-radius:8px;padding:9px 11px;font-size:12.5px;color:#374151">1. Réclamation écrite à la compagnie</div>
<div style="text-align:center;color:#9CA3AF;font-size:15px">↓</div>
<div style="background:#F3F4F6;border-radius:8px;padding:9px 11px;font-size:12.5px;color:#374151">2. Attente ou refus (≈ 2 mois)</div>
<div style="text-align:center;color:#9CA3AF;font-size:15px">↓</div>
...
<div style="flex:1 1 250px;border:2px solid #00C87A;border-radius:12px;overflow:hidden;background:#fff">
<div style="background:#00C87A;color:#0B1F3A;font-weight:800;padding:11px 14px;font-size:13px">🚀 Avec Robin des Airs (cession)</div>
<div style="padding:14px">
<div style="background:#EFF9F4;border-radius:8px;padding:9px 11px;font-size:12.5px;color:#0B1F3A">1. Dépôt en 5 min (WhatsApp ou site)</div>
<div style="text-align:center;color:#00C87A;font-size:15px">↓</div>
<div style="background:#EFF9F4;border-radius:8px;padding:9px 11px;font-size:12.5px;color:#0B1F3A">2. On rachète votre créance</div>
<div style="text-align:center;color:#00C87A;font-size:15px">↓</div>
<div style="background:#EFF9F4;border-radius:8px;padding:9px 11px;font-size:12.5px;color:#0B1F3A">3. Pas de médiation : litige entre professionnels</div>
<div style="text-align:center;color:#00C87A;font-size:15px">↓</div>
<div style="background:#EFF9F4;border-radius:8px;padding:9px 11px;font-size:12.5px;color:#0B1F3A">4. Assignation directe au tribunal de commerce, à nos frais</div>
<div style="text-align:center;color:#00C87A;font-size:15px">↓</div>
<div style="background:#EFF9F4;border-radius:8px;padding:9px 11px;font-size:12.5px;color:#0B1F3A">5. Vous êtes payé, commission seulement au succès</div>
<div style="margin-top:11px;font-size:12px;color:#047857;font-weight:700">✅ 0 € d'avance, vous ne faites plus rien jusqu'au gain</div>
</div>
</div>
</div>

*Deux chemins pour la même indemnité. À gauche, vous portez tout le poids et le temps. À droite, vous déposez en 5 minutes et vous ne vous occupez plus de rien jusqu'au versement.*

|  | Médiation MTV seul | Service CE 261 (cession) |
|---|---|---|
| Coût pour vous | Gratuit | 0 € d'avance, au succès |
| Qui monte le dossier | Vous | Le service |
| Étape médiation | Obligatoire, 3 à 5 mois | Contournée (litige B2B) |
| Si la compagnie refuse | À vous de saisir le tribunal | Assignation prise en charge |
| Rapport de force | Particulier isolé | Professionnel qui assigne |

<p style="text-align:center;margin:1.5rem 0"><a href="https://robindesairs.eu/depot-express" style="display:inline-block;background:#00C87A;color:#0B1F3A;font-weight:800;text-decoration:none;padding:.85rem 1.5rem;border-radius:.6rem">💰 Vérifier mon vol en 2 min, 0 € d'avance</a></p>

## Et si vous tentez le MTV seul et que ça échoue ?

Rien n'est perdu. Vous pouvez ensuite :
...
- Ou nous céder votre créance à ce moment-là : on reprend le dossier et on assigne.

## Robin des Airs

On ne vous laisse pas patienter des mois. On **rachète votre créance**, on notifie la compagnie, et si elle refuse ou garde le silence, on **assigne directement** avec un dossier étayé (jurisprudence, METAR/TAF, calcul d'arrivée précis). Vous n'avancez rien : on ne gagne que si vous êtes indemnisé, **jusqu'à 600 € par passager**.

Ceci dit, si vous préférez tenter la médiation gratuite par vous-même, le guide ci-dessus vous donne toutes les étapes. Les deux voies sont légitimes : la nôtre vous décharge de tout et vise le résultat le plus rapide.

À lire aussi : [Médiation aérienne obligatoire 2026](/blog/mediation-aerienne-obligatoire-2026.html), [Compagnie refuse de payer](/blog/compagnie-refuse-payer-indemnite-que-faire.html).

→ [Confier mon dossier à Robin](https://robindesairs.eu/#funnel-box)
→ [WhatsApp, mon dossier est refusé](https://wa.me/33756863630)
