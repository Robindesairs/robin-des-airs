---
title: "Surbooking : le volontaire touche souvent moins que celui qu'on refuse"
meta_title: "Surbooking et refus d'embarquement : vos droits, jusqu'à 600 €"
meta_description: "Se porter volontaire et être refusé ne relèvent pas du même régime. Le refusé touche 250 à 600 € de plein droit, le volontaire seulement ce qu'il a négocié."
slug: surbooking-refus-embarquement-indemnite
hreflang_en: denied-boarding-overbooking-compensation
image_url: /og-blog.png
faq:
  - q: "Le surbooking est-il légal ?"
    a: "Aucun texte européen ne l'interdit. Le règlement CE 261/2004 ne s'attaque pas à la pratique, il en **organise les conséquences** : il oblige la compagnie à chercher des volontaires, puis à indemniser ceux qu'elle refuse contre leur gré. Autrement dit, la compagnie a le droit de survendre, à condition d'en payer le prix."
  - q: "Je me suis porté volontaire. Ai-je droit aux 600 € ?"
  ...
  - q: "Combien de temps dois-je attendre avant d'être indemnisé ?"
    a: "Aucun délai. Contrairement au retard, qui exige d'atteindre 3 heures à l'arrivée, le refus d'embarquement ouvre l'indemnité **au moment même du refus**. Vous n'avez rien à attendre, rien à mesurer."
  - q: "La compagnie peut-elle invoquer une circonstance extraordinaire ?"
    a: "Non. Le surbooking est une décision commerciale prise par la compagnie elle-même, des semaines avant le vol. Rien d'extérieur, rien d'imprévisible. C'est l'un des rares cas où l'argument de la circonstance extraordinaire ne peut tout simplement pas prospérer."
  - q: "On m'a refusé l'embarquement, mais l'avion n'était pas surbooké. Ai-je quand même droit à l'indemnité ?"
    a: "Très probablement oui. La Cour de justice a jugé que le refus d'embarquement **ne se limite pas à la surréservation** et couvre aussi les refus fondés sur des motifs opérationnels. Un changement d'appareil pour un modèle plus petit, une limitation de masse au décollage, une réorganisation après une perturbation : le passager laissé au sol relève du même régime."
  - q: "Comment éviter de faire partie de ceux qu'on refuse ?"
  ...
  - q: "Une famille peut-elle être séparée en cas de surbooking ?"
    a: "Le règlement ne protège pas la réservation de groupe. Rien n'oblige la compagnie à laisser une famille voyager entière, ni à la débarquer entière. En revanche, **chaque personne refusée détient son propre droit à indemnité** : trois refusés sur un vol vers l'Afrique, c'est 1 800 €."
  - q: "La compagnie propose de me faire partir deux heures plus tard. Peut-elle diviser l'indemnité par deux ?"
    a: "Elle peut le tenter. Le règlement lui ouvre cette faculté quand le réacheminement vous fait arriver avec un retard limité, jusqu'à 4 heures sur les vols de plus de 3 500 km. C'est une **faculté, pas un droit acquis** : elle doit l'invoquer et démontrer que les conditions sont réunies. Nous réclamons toujours le montant plein."
  - q: "Je me suis présenté tard à l'enregistrement. Puis-je réclamer ?"
    a: "Non. Le règlement exige que vous vous soyez présenté à l'enregistrement à l'heure indiquée par la compagnie, ou à défaut **au plus tard 45 minutes avant le départ**. C'est la première chose que la compagnie vérifiera, et le motif de rejet le plus facile à vous opposer."
  - q: "La compagnie est africaine ou turque. Le règlement s'applique-t-il ?"
    a: "Au départ d'un aéroport européen, oui, quelle que soit la nationalité de la compagnie. Un refus d'embarquement à Paris, Bruxelles, Lyon ou Marseille ouvre les mêmes droits. C'est **au retour** que la règle change : depuis l'Afrique, il faut une compagnie européenne."
---

**Un refus d'embarquement vaut jusqu'à 600 € par passager, immédiatement.** On vérifie gratuitement votre éligibilité, 0 € d'avance, et vous ne payez rien si on ne récupère rien.
...
<img src="/assets/images/surbooking-volontaire-vs-refuse.svg" alt="Schéma comparant les droits du passager volontaire et du passager refusé contre son gré en cas de surbooking : le refusé touche l'indemnité forfaitaire de 250 à 600 euros de plein droit, le volontaire seulement ce qu'il a négocié" width="1200" height="630" loading="lazy" decoding="async">
...
Et méfiez-vous du bon d'achat, qui vaut rarement ce qu'il affiche. Nous l'expliquons en détail sur notre page consacrée au [bon d'achat proposé à la place de l'indemnité](https://robindesairs.eu/blog/bon-achat-compagnie-aerienne-piege.html).

<aside class="cta-inline">
  <p class="cta-inline-t">On vous a refusé l'embarquement ?</p>
  <p class="cta-inline-p">L'indemnité est due au moment du refus, sans aucun délai d'attente. Vérification gratuite, 0 € d'avance, jusqu'à 600 € par passager.</p>
...
**La prise en charge**, dès le refus constaté : repas et boissons en proportion de l'attente, hôtel et transferts si vous ne partez que le lendemain, deux communications gratuites. Le détail des seuils figure sur notre page consacrée aux [frais que la compagnie doit rembourser](https://robindesairs.eu/blog/remboursement-frais-assistance-ce261.html).
...
C'est au retour que tout change : depuis un aéroport africain vers l'Europe, il faut que la compagnie soit européenne. Cette asymétrie est décisive sur nos lignes, et nous l'expliquons sur notre page consacrée à [la compagnie qui doit indemniser](https://robindesairs.eu/blog/compagnie-africaine-partenaire-air-france-klm-qui-indemnise.html).
...
<aside class="cta-inline">
  <p class="cta-inline-t">Vous avez accepté un bon à la porte d'embarquement ?</p>
  <p class="cta-inline-p">Ce n'est pas forcément la fin de l'histoire. Faites vérifier ce à quoi vous aviez réellement droit. Vérification gratuite, 0 € d'avance.</p>
