...
faq:
  - q: "C'est quoi un vol en partage de code (code-share) ?"
    a: "Un accord entre deux compagnies : l'une **vend** le billet sous son propre numéro de vol, l'autre **opère** réellement l'avion. Vous pouvez acheter un « vol Air France » qui est en fait opéré par une autre compagnie."
  - q: "En code-share, qui doit payer l'indemnité en cas de retard ?"
    a: "La compagnie qui **opère** effectivement le vol (*operating carrier*), pas celle qui a vendu le billet (article 2(b) du CE 261/2004). Robin des Airs identifie l'opérateur et adresse le dossier au bon interlocuteur."
  - q: "Comment savoir quelle compagnie opère mon vol ?"
    a: "Cherchez la mention **« opéré par »** (*operated by*) sur la réservation ou la carte d'embarquement. Le numéro de vol et un site comme Flightradar24 confirment l'opérateur réel."
  - q: "Un vol code-share au départ d'Afrique est-il couvert par le CE 261 ?"
    a: "Au départ d'un pays hors UE, vous êtes couvert **uniquement si la compagnie qui opère réellement est européenne**. Au retour depuis l'Europe, vous êtes couvert dans tous les cas."
  - q: "Les deux compagnies se renvoient la balle. Que faire ?"
    a: "Ce ping-pong est fréquent. Adressez-vous **directement au transporteur qui opère** l'avion. Robin des Airs tranche et pousse le dossier au bon endroit, sans aller-retour, 0 € d'avance."
---
...
- **La carte d'embarquement** : la compagnie qui y apparaît est en général l'opérateur. Pour tout décrypter, voyez [comment lire votre carte d'embarquement](/blog/comment-lire-carte-embarquement-droits-passager.html).
...
- [Code-share Air France / KLM : quelle compagnie vous indemnise](/blog/code-share-air-france-klm-quelle-compagnie-recours.html) ;
- [Compagnie africaine partenaire d'Air France / KLM : qui indemnise](/blog/compagnie-africaine-partenaire-air-france-klm-qui-indemnise.html).

À ne pas confondre avec la **location d'avion avec équipage (wet lease)**, où une compagnie sous-traite tout un appareil : là aussi, [c'est le transporteur qui exploite réellement le vol qui répond](/blog/arret-wirth-qui-doit-payer-wet-lease.html) (arrêt Wirth de la CJUE).
...
1. Identifiez le **transporteur effectif** (voir plus haut).
2. Adressez-lui **directement** votre réclamation, sur le fondement de l'article 2(b) du CE 261.
3. Conservez tout : carte d'embarquement, e-mail d'annulation, numéro de vol, heure réelle d'arrivée.

Ou laissez-nous trancher pour vous. **Robin des Airs identifie l'opérateur, vise la bonne compagnie et porte le dossier**, sans avance de frais. On prend aux compagnies, on rend aux familles. [Vérifier mon éligibilité en 2 minutes](/#funnel-box).
