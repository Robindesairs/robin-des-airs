---
title: "Réclamer seul ou passer par un service ? La réponse honnête, cas par cas"
meta_title: "Réclamer seul ou passer par un service ? Le vrai calcul"
meta_description: "Dans un cas, faites-le vous-même, c'est simple et vous gardez tout. Dans les autres, voici ce qui coince, et ce que ça change de déléguer."
slug: reclamer-seul-ou-passer-par-un-service-indemnite-vol
image_url: /og-blog.png
faq:
  - q: "Puis-je vraiment réclamer seul ?"
    a: "Oui, et dans certains cas vous devriez. La démarche est gratuite, l'avocat n'est **pas obligatoire** en dessous de 10 000 € devant le tribunal, et le dossier le plus simple, le refus d'embarquement pour surbooking, se règle très bien sans intermédiaire."
  - q: "Combien de temps la compagnie a-t-elle pour me répondre ?"
    a: "Aucun délai ne lui est imposé. C'est une idée fausse très répandue : le règlement européen est **muet** sur ce point. La Commission européenne recommande deux mois, elle ne les impose pas. Une compagnie qui ne répond pas n'enfreint donc aucun délai."
  - q: "Que se passe-t-il si je vais au tribunal ?"
    a: "Sous 5 000 €, une **tentative de règlement amiable est obligatoire** avant toute saisine, à peine d'irrecevabilité. Ensuite, une procédure au fond dure en moyenne **8,4 mois** devant le tribunal judiciaire, tous contentieux confondus. Pour 600 €, c'est long."
  - q: "Le refus de la compagnie est-il définitif ?"
    a: "Presque jamais. Selon la Cour des comptes européenne, parmi les refus fondés sur des circonstances extraordinaires que des passagers ont contestés, **environ 60 % ne relevaient en réalité pas de circonstances extraordinaires**. Un premier refus est une étape, pas une conclusion."
  - q: "Combien coûte un service comme Robin des Airs ?"
    a: "**25 %** de ce qui est récupéré en phase amiable, **40 %** si le dossier doit aller au tribunal, frais d'avocat et de procédure inclus. Et **0 €** si rien n'est récupéré. Vous n'avancez jamais rien."
  - q: "Dans quel cas vaut-il mieux faire soi-même ?"
    a: "Le surbooking. C'est le cas le plus binaire du règlement : soit vous avez embarqué, soit non. Il n'y a pas de circonstance extraordinaire à discuter, donc peu de matière à contestation. Faites-le vous-même et gardez la totalité."
---
...
<aside class="cta-inline">
  <p class="cta-inline-t">Vous avez déjà reçu un refus ?</p>
  <p class="cta-inline-p">Selon la Cour des comptes européenne, la majorité des refus contestés pour circonstances extraordinaires ne tenaient pas. Vérification gratuite, 0 € d'avance.</p>
...
<aside class="cta-inline">
  <p class="cta-inline-t">On regarde votre dossier avant que vous décidiez</p>
