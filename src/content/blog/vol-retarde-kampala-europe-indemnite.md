...
faq:
  ...
  - q: "Mon vol retour Kampala-Europe est retardé. Suis-je couvert ?"
    a: "Cela dépend de la compagnie. Au départ d'Entebbe (hors UE), le CE 261 ne s'applique que si la compagnie est **européenne** : Brussels Airlines (via Bruxelles) et KLM (via Amsterdam) sont couvertes. Avec une compagnie non européenne (Uganda Airlines), le forfait n'est pas dû sur ce sens, mais la Convention de Montréal permet de réclamer les frais réels justifiés."
  - q: "Mon vol Kampala-Europe sur Uganda Airlines a été très retardé. Je n'ai droit à rien ?"
    a: "Pas au forfait CE 261 sur ce sens (Uganda Airlines est une compagnie non-UE au départ d'un pays non-UE). Mais la **Convention de Montréal** couvre vos frais réels (repas, hôtel, achats de première nécessité, sur justificatifs), et votre vol aller Europe-Kampala, lui, reste indemnisable à 600 €."
  - q: "Nous voyagions en famille. L'indemnité est-elle par personne ?"
    a: "Oui. **Chaque passager avec un billet compte**, enfants inclus (et bébé si quelque chose a été payé pour lui). Une famille de 4 sur un Kampala-Europe retardé de 3h+ : 4 x 600 € = 2 400 € bruts, soit 1 800 € nets après la commission de 25 % au succès."
  ...
  - q: "Mon vol date d'il y a deux ans. Est-ce trop tard ?"
    a: "Non. Devant les juridictions françaises, vous avez **5 ans** pour réclamer une indemnité CE 261 (art. 2224 du Code civil). Un vol Kampala-Europe retardé il y a deux ans reste indemnisable."
---

**Votre vol Europe-Kampala ou Kampala-Europe a été retardé de 3h ou plus, ou annulé ? Vous pouvez réclamer jusqu'à 600 € par passager (règlement CE 261/2004).** Le sens Europe vers Kampala est toujours couvert, quelle que soit la compagnie. Le sens Kampala vers Europe est couvert uniquement avec une compagnie européenne (Brussels Airlines (via Bruxelles) et KLM (via Amsterdam)). Vérification gratuite, 0 € d'avance.
...
- **Le vol part d'un aéroport de l'UE** (Bruxelles, Amsterdam, Paris) : couvert quelle que soit la compagnie, même non européenne.
- **La compagnie est européenne** : couverte dans les deux sens, y compris au départ d'Entebbe.

| Trajet | Compagnies | Indemnité CE 261 si retard >= 3h |
|---|---|---|
| Europe vers Kampala | Brussels Airlines (via Bruxelles), KLM (via Amsterdam), Uganda Airlines | Oui : **600 € par passager** |
| Kampala vers Europe | Brussels Airlines (via Bruxelles), KLM (via Amsterdam) | Oui : **600 € par passager** |
| Kampala vers Europe | Uganda Airlines | Non : frais réels via Convention de Montréal |

Le seuil se mesure **à l'arrivée** (ouverture des portes), pas au départ.

## Les compagnies sur la ligne

- **Compagnies européennes** (couvertes dans les deux sens) : Brussels Airlines (via Bruxelles) et KLM (via Amsterdam)
- **Compagnies non européennes** (couvertes uniquement au départ de l'UE) : Uganda Airlines

## Vol avec correspondance

Si votre billet est une **réservation unique** avec correspondance, le retard se mesure à la **destination finale** (arrêt Folkerts, CJUE 2013). Une correspondance manquée à Bruxelles ou Amsterdam qui vous fait arriver avec 3h+ de retard ouvre droit à l'indemnité, calculée sur la distance totale du trajet, même si l'une des étapes est opérée par une autre compagnie.

## Vol annulé Kampala-Europe : vos droits
...
**5 ans** devant les juridictions françaises (art. 2224 du Code civil). Un vol Kampala-Europe retardé il y a deux ou trois ans reste indemnisable aujourd'hui.

## Famille : chaque passager compte

L'indemnité est due **par passager**, sans distinction d'âge. Exemple : famille de 4 sur un Kampala-Europe arrivé avec 4h de retard : 4 x 600 € = **2 400 € bruts**, soit **1 800 € nets** après la commission de 25 % au succès.
...
**En pratique :** déposez votre dossier **en ligne en 2 minutes** ([formulaire guidé](https://robindesairs.eu/depot-express), sans WhatsApp) ou directement **sur WhatsApp**, avec rappel possible en luganda.

→ [Déposer mon dossier Kampala-Europe en 2 min](https://robindesairs.eu/depot-express)
