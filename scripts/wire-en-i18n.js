...
const E = [
  ...
  { key:'hero_wa_demo_sr', attr:'i18n', find:'<span class="sr-only">Exemple de conversation WhatsApp : vous envoyez votre numéro de vol puis une photo de votre carte d\'embarquement ; Robin lit le vol, confirme l\'éligibilité et l\'indemnité — jusqu\'à 600 € par passager. Robin précise que le passager perçoit 75 % des sommes récupérées, au succès seulement (0 € si on ne gagne pas, aucune avance), son expertise des vols Europe–Afrique (Dakar, Abidjan, Bamako) et qu\'il répond en wolof, bambara, lingala ou français.</span>',
    fr:'Exemple de conversation WhatsApp : vous envoyez votre numéro de vol puis une photo de votre carte d\'embarquement ; Robin lit le vol, confirme l\'éligibilité et l\'indemnité — jusqu\'à 600 € par passager. Robin précise que le passager perçoit 75 % des sommes récupérées, au succès seulement (0 € si on ne gagne pas, aucune avance), son expertise des vols Europe–Afrique (Dakar, Abidjan, Bamako) et qu\'il répond en wolof, bambara, lingala ou français.',
