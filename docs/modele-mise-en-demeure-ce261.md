...
**Robin des Airs** — Mandataire du/des passager(s)
...
> La compagnie ne saurait utilement invoquer une circonstance extraordinaire (art. 5 §3) : [aucune cause externe — grève/météo — n'a affecté l'aéroport ce jour / le retard résulte d'un problème technique propre à l'appareil / retard importé d'une rotation précédente]. Le caractère extraordinaire et l'évitabilité doivent être prouvés par le transporteur (CJUE C-549/07, *Wallentin-Hermann*).

À défaut de paiement dans le délai imparti, nous engagerons toute action utile devant la juridiction compétente, **après mise en œuvre de la médiation préalable obligatoire** [pour Air France et compagnies adhérentes : auprès du **Médiateur du Tourisme et du Voyage (MTV)**, depuis le 6 février 2026], les frais et intérêts restant à votre charge.

Dans l'attente de votre règlement à l'ordre de notre mandant, nous vous prions d'agréer, Madame, Monsieur, l'expression de nos salutations distinguées.

*Pour Robin des Airs, mandataire*
[Nom / signature]

---

## Notes d'usage par compagnie
- **Air France (AF)** : médiation **MTV obligatoire** avant le juge (depuis 6/2/2026). Oppose systématiquement les **5 ans** s'ils invoquent 2 ans. Couvre l'axe Afrique→Europe (départ UE toutes cies / arrivée UE si cie UE).
- **Brussels Airlines (SN)** : compagnie UE → CE 261 direct (BRU↔Afrique inclus). Minimum recevable : confirmation de réservation + preuve du retard.

_Réf. : voir `docs/pieces-requises-ce261-af-sn.md`. Mise à jour 2026-06-04._
